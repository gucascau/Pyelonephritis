...
RequestedGenes["PanTCell"] <- c("Cd3e", "Cd3d", "Cd3g", "Trac")
RequestedGenes["CD4T"] <- c("Cd4")
RequestedGenes["CD8T"] <- c("Cd8a", "Cd8b1")
RequestedGenes["Tregs"] <-c("Cd4", "Il2ra", "Foxp3", "Ctla4", "Ikzf2")
RequestedGenes["PanTCell"] <- c("Cd3e", "Cd3d", "Cd3g", "Trac")
RequestedGenes["Th1"] <-c("Tbx21", "Ifng")
RequestedGenes["Th2"] <-c("Gata3", "Il4", "Il5", "Il13")
RequestedGenes["Th17"] <- c("Rorc", "Il17a", "Il17f")
RequestedGenes["Tfh"] <- c("Bcl6", "Cxcr5", "Il21")
RequestedGenes["ExhaustedT"] <- c("Pdcd1", "Lag3", "Havcr2" , "Tigit")
RequestedGenes["Trm"] <- c("Itgae", "Cd69", "Cxcr6")


# B cells
RequestedGenes["PanB"] <-c("Cd19", "Ms4a1", "Cd79a", "Cd79b")
RequestedGenes["MatureB"] <-c("Cd19", "Cd23", "Cd21")
RequestedGenes["PlasmaCell"] <-c("Prdm1", "Xbp1", "Sdc1")
RequestedGenes["GeminalCenterB"] <-c("Bcl6", "Aicda")

# Monocyte 
RequestedGenes["Monocyte"] <-c("Cd11b", "Ly6c2", "Ccr2", "Fcgr3")
RequestedGenes["ResidentMacrophages"] <-c("Adgre1", "Cd11b", "Cd64", "Mertk")
RequestedGenes["InfiltratingMacrophages"] <-c("Ly6c", "Ccr2", "Cd11b")
RequestedGenes["M1like"] <-c("Nos2", "Il1b", "Tnf")
RequestedGenes["M2like"] <-c("Mrc1", "Arg1", "Chil3")

# neutrophil
RequestedGenes["Neutrophil"] <-c("Ly6g", "S100a8", "S100a9", "Mpo", "Elane", "Cxcr2")

# Dendritic
RequestedGenes["cDC1"] <-c("Xcr1", "Batf3", "Clec9a", "Cd8a")
RequestedGenes["cDC2"] <-c("Cd11b", "Irf4", "Sirpa")
RequestedGenes["pDCs"] <-c("Siglech", "Bst2", "Tcf4")

# NK cell
RequestedGenes["NK"] <-c("Ncr1", "Klrb1c", "Gzmb", "Prf1")


# Innate lymphoid cells
RequestedGenes["ILC1"] <-c("Tbx21", "Ifng", "Ncr1")
RequestedGenes["ILC2"] <-c("Gata3", "Il5", "Il13", "Rora")
RequestedGenes["ILC3"] <-c("Rorc", "Il17a", "Il22")
# Eosinophil
RequestedGenes["Eosinophil"] <-c("Siglecf", "Gata1", "Prg2")
...
RequestedGenes["Fibroblast"] <-c("Pdgfra", "Col1a1", "Col3a1","Dcn", "Postn")
RequestedGenes["Myofibroblast"] <-c("Acta2", "Postn", "Tagln")
RequestedGenes["Pericyte"] <-c("Pdgfrb", "Rgs5", "Cspg4")
RequestedGenes["Endothelial"] <-c("Pecam1", "Cdh5", "Kdr")
RequestedGenes["LymphaticEC"] <-c("Lyve1", "Pdpn", "Prox1")
RequestedGenes["vSMC"] <-c("Acta2", "Myh11", "Tagln","Cnn1")
RequestedGenes["Mesangial"] <-c("Itga8", "Pdgfrb", "Cxcl12")
