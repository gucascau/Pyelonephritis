...
Outdir =c("/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Cell_Cell_Communication_V08012024/")
...
# read the spatial 
SpatialObj <- readRDS(file = paste0(Spindir,"Pyelonephritis_Infection_Deconvoluted_v07292024.RDS"))
...
RequestedGenesDotPlot <-
 ...
 ggsave("Ligand_DotPlot.pdf", plot = RequestedGenesDotPlot, height = 7, width = 6)
...
for (j in RequestedGenes) {
    ...
    ggsave(
      filename = paste0(RequestedDir, "/", "Spatial_", j, "_Ligand.pdf"),
    ...
    # save the figure into the folder
    ggsave(
      filename = paste0(RequestedDir, "/", "SingleCell_", j, "_Ligand.pdf"),
