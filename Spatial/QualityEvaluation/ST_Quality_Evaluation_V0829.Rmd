...
SpatialDimNoLable <- SpatialDimPlot(Subcluster0)
ggsave("SpatialIntegrated_Pyeloneprhitis_harmony_SpatialDimplot_withoutlabels_onlySlide.pdf", plot = SpatialDimNoLable, height = 6, width = 14)
