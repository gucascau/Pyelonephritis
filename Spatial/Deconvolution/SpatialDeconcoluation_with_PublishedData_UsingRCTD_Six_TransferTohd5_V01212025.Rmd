...
date: "2023-08-23"
Description: 
#   Deconvolute the spatial spots using Published Single cells 

#     Note:
#    #     The publication of single cell is "A comprehensive mouse kidney atlas enable rare cell population characteration and robust marker discovery"
...
#BiocManager::install("SPOTlight", force = TRUE)
library(SPOTlight)
library(tidyHeatmap)
...
Scindir = "/Users/XXW004/Documents/Projects/RuizRosado/PIPseq/Results/Evaluation_V022723/CellEvaluation_Subclustering_V0803/AnnotationValidation/"
# Mouse_ATLAS_reference.rds
...
# Output directory :
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/"

# Cell types deconvolution:

Ctdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/CellTypes/"

# Cell types heatmap for scaled component

CAbdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/CellTypesAbundance/"

# Cell types heatmap for cell type correlated

CCordir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/CellTypesCorrelation/"

# Biomarkers
CBiomadir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/CellTypesBiomarkers/"

# InfectionCellTypesScatterPieDir

CPiedir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/CellTypesScatterPieDir/"

# Concentrate on the infection area abscess and margion region

InfCPiedir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/InfectionCellTypesScatterPieDir/"
# InfectionCellTypesScatterPieDir

# Concentrate on the infection area abscess from pelvis

InfPelvisdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/InfPelvisRegionDir/"

# Concentrate on the Control area 

Contrdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/ControlD0/"
# Concentrate on the day 7 area
Day7dir =  "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/Day7/"
...
getwd()
setwd("/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/")
```
...
ref <-
  readH5AD(file =  ("/Users/XXW004/Documents/Projects/RuizRosado/PIPseq/Datasets/Reference_Published/MKA_MouseKidney/adata.h5ad"))
# tips:
ref
...
allen_reference <- as.Seurat(ref, counts = "X", data = NULL)

allen_reference@meta.data %>% head()
rownames(allen_reference)
Idents(allen_reference) <- "Celltype"
...
# # 1. Ensure the gene matching
# # common_genes <- intersect(rownames(Pyelonephritis_Infection), rownames(allen_reference)) 
# # #length(common_genes)
# # Idents(allen_reference)
# # 
# # Pyelonephritis_Infection@assays$Spatial$counts[]
# # # we need to add the common genes from single cell and spatial
# # spatial <- SpatialRNA::SpatialRNA(counts = spatial@counts[common_genes, ])
# # reference <- reference[common_genes, ]

# take a look at the data
head(allen_reference@meta.data)
DimPlot(object = allen_reference,
        group.by = "Celltype")

# spacexr doesn't like labels with "/" in it, so let's change that
allen_reference$Celltype <-
  gsub(pattern = "/", 
       replacement = "-", 
       x = allen_reference$Celltype)
GetAssayData(object = allen_reference, layer = "counts")
# create the spacexr reference object
spacexr_reference <-
    spacexr::Reference(counts = GetAssayData(object = allen_reference, 
                                             layer = "counts"),
                       cell_types = as.factor(allen_reference$Celltype))
...
saveRDS(Pyelonephritis_Infection, file = "Pyelonephritis_Infection_ATLAS_RCTD_Deco.rds")

Pyelonephritis_Infection <- readRDS(file = "Pyelonephritis_Infection_ATLAS_RCTD_Deco.rds")

myPalette <- colorRampPalette(rev(brewer.pal(11, "Spectral")))

CelltypeOrder<- levels(as.factor(allen_reference$Celltype))
...
# Visualize spot deconvolution with SPOTlight
```{r}

# 
CellTypes<-levels(as.factor(allen_reference@meta.data$Celltype))
...
colorset <- c( 
   ...
   "#f47a22",# B 
   "#9b59b6",#NK 
   "#5858e1",  "#1eefc9", "#fb2076"
  )


CelltypeOrder <- c("PTS1","PTS2","PTS3","PTS3T2","PEC","DTL","DTL-ATL","ATL","MTAL","DCT","DCT-CNT","CNT","CTAL","DC","Podo","LOH","PC","ICA","ICB","CD-Trans","Fib","Endo","Glom-Endo","Asc-Vasa-Recta","Desc-Vasa-Recta","Vas-Afferens","Vas-Efferens","Macro","Neutro","T lymph","NK","B lymph","MC","MD","Per","Unknown")
length(colorset)
...
```{r}
Allimagmes= Images(Pyelonephritis_Infection)
...
for (Pdate in Condition) {
  ...
  InfectedMat <-
    Pyelonephritis_InfectionSubslides@meta.data[,CelltypeOrder]
 ...
 InfectedMat<- InfectedMat %>%  as.matrix()
  # correlation
  plotCorrelationMatrix(na.omit(as.matrix(InfectedMat)))
  #plotInteractions(na.omit(InfectedMat), "heatmap")
  ...
  InfectedMat[InfectedMat < 0.001] <- 0
...
Condition<- levels(Pyelonephritis_Infection$orig.ident)
...
setwd("/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Withpublised_V06182025/InfMadullaRegionDir/")
