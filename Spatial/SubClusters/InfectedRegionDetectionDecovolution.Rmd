...
date: "2023-05-02"
Description: 
#   Perform the Deconvolution of the Kidney
#    - Deconvolution of the kidney
#    - Validate with the marker genes
#    - Draw the FeaturePlots 
...
## save the annotated Pyelonephritis

saveRDS(Pyelonephritis_Infection, file = "Pyelonephritis_Infection_decovoluted.rds")
