...
# Output directory :
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/"

# Cell types deconvolution:

CDecodir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/Deconvolution/"

# BasicSpatialDim

CAbdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/BasicSpatialDim/"

# Biomarkers
CBiomadir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/CellTypesBiomarkers/"


CDEGdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/DEGs/"

# GOEnrichment

CGOEndir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/GOenrich/"

# Progeny
CProgenydir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/Progeny/"

# Transcript factor
CTFdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/TranscriptFactors/"

# Niche niche Communication

CNichComdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/NicheCommunicate/"

# Concentrate on the infection area abscess from CorMed

InfCorMeddir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay7/"
...
SpatialDimPlot(Pyelonephritis_InfectionSubslidesD7,pt.size.factor = 1500)
...
# Pyelonephritis_InfectionSubslidesD7 <- subset (Pyelonephritis_InfectionSubslidesD7,slice8_imagerow > 270 | slice8_imagecol > 270, invert = TRUE)
# SpatialDimPlot(Pyelonephritis_InfectionSubslidesD7, pt.size.factor = 1500)
# Pyelonephritis_InfectionSubslidesD7 <- subset (Pyelonephritis_InfectionSubslidesD7, idents = c("N13","N14","N15","N16","N17"))
InfectedCorMedRegionD7Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD7,label = TRUE, pt.size.factor =1600)
 ?SpatialDimPlot
...
# InfectedCorMedRegionD7SpatialDim<- DimPlot(Pyelonephritis_InfectionSubslidesD7,label = TRUE)
...
# 
# 
#  ordered((rownames(Pyelonephritis_InfectionSubslidesD7[["predictions"]]@data)),levels =CelltypeOrder)
#  
# get the summary of the selected regions
 GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD7)
 summary(GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD7))
```
# ############################## 
...
InfectedMat_CorMed<- t(Pyelonephritis_InfectionSubslidesD7[["predictions"]]@data)
...
Seurat::SpatialDimPlot(Pyelonephritis_InfectionSubslidesD7,pt.size.factor = 1500)
# Prepare input data for CelChat analysis
data.input = Seurat::GetAssayData(Pyelonephritis_InfectionSubslidesD7, slot = "data", assay = "SCT") # normalized data matrix
#> Warning: The `slot` argument of `GetAssayData()` is deprecated as of SeuratObject 5.0.0.
Seurat::Idents(Pyelonephritis_InfectionSubslidesD7)
...
meta = data.frame(labels = Seurat::Idents(Pyelonephritis_InfectionSubslidesD7), samples = "sample1", row.names = names(Seurat::Idents(Pyelonephritis_InfectionSubslidesD7))) # manually create a dataframe consisting of the cell labels
meta
...
spatial.locs = Seurat::GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD7, scale = NULL, cols = c("imagerow", "imagecol")) 
...
RequestedClusters<- levels(Idents(Pyelonephritis_InfectionSubslidesD7))
RequestedClusters
...
Finalcelltypemarkers<- c("Lrp2","Slc34a1","Slc13a3", # Proximal tubule cells (PT)
 ...
 for (i in Finalcelltypemarkers){
   CellTypeMarkerSpatialFeature<- SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = i, pt.size.factor = 6000, crop = TRUE)
...
? FindAllMarkers
Pyelonephritis_InfectionSubslidesD7 <- ScaleData(object = Pyelonephritis_InfectionSubslidesD7, features = rownames(Pyelonephritis_InfectionSubslidesD7))
# MAST was used to calculate the cluster
CorMed_nichesBiomarkers <-
  FindAllMarkers(
    object = Pyelonephritis_InfectionSubslidesD7,
...
CorMed_nichesBiomarkersTop5Heatmap<- DoHeatmap(Pyelonephritis_InfectionSubslidesD7, features = CorMed_nichesBiomarkersTop5 , slot = "scale.data") + scale_fill_gradientn(colors = c("blue", "white", "red")) + theme(axis.text.y = element_text(size = 10))
ggsave(
...
CorMedCorMedPTSubBiomarkersTop5DotPlot <-
  DotPlot(Pyelonephritis_InfectionSubslidesD7, features = CorMed_nichesBiomarkersTop5 %>% unique()) +
  RotatedAxis()
...
for (i in Top5PTMarker) {
  ...
  PTmarkerSpatialFeature <-
    SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = i, slot = "scale.data",pt.size.factor = 4)
...
for (n in Idents(Pyelonephritis_InfectionSubslidesD7)) {
...
CorMedCluster<- data.frame(Cell = names(Idents(Pyelonephritis_InfectionSubslidesD7)),   
                              CellType = as.character(Idents(Pyelonephritis_InfectionSubslidesD7)),
                              stringsAsFactors = FALSE)

?progeny
Pyelonephritis_InfectionSubslidesD7 <- progeny(Pyelonephritis_InfectionSubslidesD7, scale=FALSE, organism="Mouse", top=500, perm=1, return_assay = TRUE,assay_name = "SCT")
Pyelonephritis_InfectionSubslidesD7
# setup the default assay as progeny
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD7) <- "progeny"

Pyelonephritis_InfectionSubslidesD7 <- Seurat::ScaleData(Pyelonephritis_InfectionSubslidesD7, assay = "progeny") 
## We can now directly apply Seurat functions in our Progeny scores. 
## For instance, we scale the pathway activity scores. 
progeny_scores_df <- 
  as.data.frame(t(GetAssayData(Pyelonephritis_InfectionSubslidesD7, slot = "scale.data", 
                               assay = "progeny"))) %>%
...
progeny_hmap
dev.off()
test<- FeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = "NFkB")
...
for (i in ProgenyFeatures ){
  p2 <-(FeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = i) & 
  scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red'))& 
  ggtitle(paste0(i," activity"))
  
  ggsave(paste0(i, "_CorMedInfected_cluster_featurePlot.pdf"), plot = p2, width = 6, height = 6)
  
  p3 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = i, pt.size.factor = 4) +ggtitle(paste0(i," activity")))
...
Pyelonephritis_InfectionSubslidesD7@assays$SCT@data %>% head()
mat <- as.matrix(Pyelonephritis_InfectionSubslidesD7@assays$SCT@data)
# Run ulm
...
Pyelonephritis_InfectionSubslidesD7[['tfsulm']] <- acts %>%
...
# Change assay
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD7) <- "tfsulm"

# Scale the data
Pyelonephritis_InfectionSubslidesD7 <- ScaleData(Pyelonephritis_InfectionSubslidesD7)
Pyelonephritis_InfectionSubslidesD7@assays$tfsulm@data <- Pyelonephritis_InfectionSubslidesD7@assays$tfsulm@scale.data

# Explore the top 20 more varaible TFs
n_tfs <- 20

t(as.matrix(Pyelonephritis_InfectionSubslidesD7@assays$tfsulm@data))
# Extract activities from object as a long dataframe
df <- t(as.matrix(Pyelonephritis_InfectionSubslidesD7@assays$tfsulm@data)) %>%
  as.data.frame() %>%
  mutate(cluster = Idents(Pyelonephritis_InfectionSubslidesD7)) %>%
...
for (m in tfs){
  p2 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = m,pt.size.factor = 4) +
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
...
Pyelonephritis_InfectionSubslidesD7
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD7) <- "SCT"

for (n in tfs){
  p3 <- (FeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = n,slot= "scale.data") + 
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression')))
  
  p4 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD7, features = n, pt.size.factor = 4, slot= "scale.data") +
 # scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression (time)')))
 
  ggsave(paste0("TFExpression_",n,"_Pyelonephritis_InfectionSubslidesD7_FeaturePlot.pdf"), plot = p3, width = 6, height = 6)
  ggsave(paste0("TFExpression_",n,"_Pyelonephritis_InfectionSubslidesD7_SpatilFeaturePlot.pdf"), plot = p4, width = 6, height = 6)
...
GeneOrderByPheatmap
?DotPlot
TFDotPlot <- DotPlot(Pyelonephritis_InfectionSubslidesD7, features = rev(GeneOrderByPheatmap)) +
...
DefaultAssay(Pyelonephritis_InfectionSubslidesD7) <- "SCT"
Pyelonephritis_InfectionSubslidesD7@meta.data %>% head()
#Idents(Pyelonephritis_InfectionSubslidesD7) <- Pyelonephritis_InfectionSubslidesD7@meta.data$Sub2

# reset the identity, Combine the PT cells

Idents(Pyelonephritis_InfectionSubslidesD7)
Pyelonephritis_InfectionSubslidesD7@meta.data
# adjust the levels
# Idents(Pyelonephritis_InfectionSubslidesD7) <-
# ordered(factor(Idents(Pyelonephritis_InfectionSubslidesD7)), levels=c( "5_1","10_1","10_0","2_1","2_0","5_0","5_2","4","7","0","1","9","6","3","8"))

levels(Idents(Pyelonephritis_InfectionSubslidesD7))
```
...
Pyelonephritis_InfectionSubslidesD7 = alias_to_symbol_seurat(Pyelonephritis_InfectionSubslidesD7, "mouse")

Pyelonephritis_InfectionSubslidesD7@meta.data %>% head()
Pyelonephritis_InfectionSubslidesD7@meta.data$IntegrateAnnot %>% table() 

head(weighted_networks$gr) 
DimPlot(Pyelonephritis_InfectionSubslidesD7)

# If you use convert_to_alias before here, this one won't work
Pyelonephritis_InfectionSubslidesD7 = Seurat::PrepSCTFindMarkers(Pyelonephritis_InfectionSubslidesD7, assay = "SCT", verbose = FALSE)
...
lr_network %>% head()
Pyelonephritis_InfectionSubslidesD7 %>% subset(features = lr_network$ligand %>% intersect(rownames(Pyelonephritis_InfectionSubslidesD7)))
# calcualte the niches difference 
DE_sender = nichenetr::calculate_niche_de(seurat_obj  = Pyelonephritis_InfectionSubslidesD7 %>% subset(features = lr_network$ligand %>% intersect(rownames(Pyelonephritis_InfectionSubslidesD7))), niches = niches, type = "sender", assay_oi = "SCT") # only ligands important for sender cell types
DE_receiver = nichenetr::calculate_niche_de(seurat_obj  = Pyelonephritis_InfectionSubslidesD7 %>% subset(features = lr_network$receptor %>% unique()), niches = niches, type = "receiver", assay_oi = "SCT") # only receptors now, later on: DE analysis to find targets
...
DE_receiver_targets = nichenetr::calculate_niche_de_targets(seurat_obj = Pyelonephritis_InfectionSubslidesD7, niches = niches, lfc_cutoff = lfc_cutoff, expression_pct = expression_pct, assay_oi = "SCT") 
...
nichenet_output = nichenet_seuratobj_aggregate(
  seurat_obj = Pyelonephritis_InfectionSubslidesD7, 
  receiver = "PT", 
...
avg_expression_ligands = AverageExpression(Pyelonephritis_InfectionSubslidesD7, features = nichenet_output$top_ligands)
...
Pyelonephritis_InfectionSubslidesD7 <- subset (Pyelonephritis_InfectionSubslidesD7, slice8_imagerow > 140 | slice8_imagecol > 200, invert = TRUE)
Pyelonephritis_InfectionSubslidesD7 <- subset (Pyelonephritis_InfectionSubslidesD7, idents = c("N13","N14","N15","N16","N17"))
InfectedCorMedRegionD1Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD7,crop = TRUE, label = FALSE)
...
FinalIntergratedTableAbcess<- merge(Pyelonephritis_InfectionSubslidesD7@meta.data[,c("orig.ident","Annotation")], t(Pyelonephritis_InfectionSubslidesD7[["predictions"]]@data), all=TRUE, by="row.names") 
?Heatmap
...
pal <- colorRampPalette(paletteMartin)(length(ct))
names(pal) <- ct
Pyelonephritis_InfectionSubslidesD7CellTypeMatrix <-t(Pyelonephritis_InfectionSubslidesD7[["predictions"]]@data)

Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax <- Pyelonephritis_InfectionSubslidesD7CellTypeMatrix[,!colnames(Pyelonephritis_InfectionSubslidesD7CellTypeMatrix) %in% c("max")]
Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax
# generate the scatter pie plot
colnames(Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax)
...
InfectedCorMedRegionD1SpatialPie<- plotSpatialScatterpie(
  x= Pyelonephritis_InfectionSubslidesD7,
  y= Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax,
  cell_types = colnames(Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax),
    img = TRUE,
    scatterpie_alpha = 1,
...
# correlation
InfectedCorMedRegionD1SpatialPieCorrelationMatrix <- plotCorrelationMatrix(Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax)
...
Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMaxLarger<- Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax[,colSums(Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMax[])>0]
InfectedPevRegionD1Interactions<- plotInteractions(Pyelonephritis_InfectionSubslidesD7CellTypeMatrixNoMaxLarger, "heatmap") + scale_fill_gradientn(colors = c("blue", "white", "red"))
?plotInteractions
...
Pyelonephritis_InfectionSubslidesD7 <- subset (Pyelonephritis_InfectionSubslidesD7, (slice8_imagerow >310 & slice8_imagerow <450 )  & (slice8_imagecol < 330 & slice8_imagecol> 220) )
Pyelonephritis_InfectionSubslidesD7 <- subset (Pyelonephritis_InfectionSubslidesD7, idents = c("N8","N10","N11","N12","N15"))
InfectedCorMedRegionD1Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD7,label = TRUE)
InfectedCorMedRegionD1Spatial
ggsave("Spatial_infected_day7_SpatialDimplot.pdf",
      plot = InfectedCorMedRegionD1Spatial,
      height = 3,
...
InfectedCorMedRegionD1Spatial
Pyelonephritis_InfectionSubslidesD7
DefaultAssay(Pyelonephritis_InfectionSubslidesD7) <- "integrated"
nbs_2.markers <- FindAllMarkers(Pyelonephritis_InfectionSubslidesD7,test.use ="MAST")
nbs_2.markers
??SubsetSTData
#nbs_2.markers$gene <- rownames(nbs_2.markers)

nbs_2.markers
#se.subset <- SubsetSTData(Pyelonephritis_InfectionSubslidesD7, expression = nbs_2 %in% c("N12", "N15"))
...
DotPlot(Pyelonephritis_InfectionSubslidesD7, features = sorted.marks$gene %>% unique()) +RotatedAxis()
#DoHeatmap(Pyelonephritis_InfectionSubslidesD7, features = sorted.marks$gene, group.colors = c("red", "lightgray"))
