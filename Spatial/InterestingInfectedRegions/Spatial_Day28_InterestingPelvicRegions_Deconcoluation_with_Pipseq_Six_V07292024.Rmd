...
date: "2024-07-29"
Description: 
#   This script is to profile the interesting infected Abscess regions at Day 28 for the cortex and medulla regions
...
# We used the cellchat inference
...
# Output directory :
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/"

# Cell types deconvolution:

CDecodir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/Deconvolution/"

# BasicSpatialDim

CAbdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/BasicSpatialDim/"

# Biomarkers
CBiomadir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/CellTypesBiomarkers/"


CDEGdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/DEGs/"

# GOEnrichment

CGOEndir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/GOenrich/"

# Progeny
CProgenydir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/Progeny/"

# Transcript factor
CTFdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/TranscriptFactors/"

# Niche niche Communication

CNichComdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/NicheCommunicate/"

# Concentrate on the infection area abscess from CorMed

InfCorMeddir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/InfectedCortexMedD28Pelvis/"
...
#dir.create(day28dir, showWarnings = F)
...
```
# ############################## 
# only concentrate on the specific infected regions with neutrophil and macro around the abcess regions at day 28
# pelvic region
# ############################## 
```{r}
setwd(CAbdir)
...
Pyelonephritis_InfectionSubslidesD28@meta.data %>% head()
summary(coords)
Pyelonephritis_InfectionSubslidesD28@images
...
D28Pelsubcluster <- subset (Pyelonephritis_InfectionSubslidesD28,(slice9_imagerow >330 & slice9_imagerow <480 )  & (slice9_imagecol < 300 & slice9_imagecol> 220))
SpatialDimPlot(D28Pelsubcluster, pt.size.factor = 1500)
D28Pelsubcluster <- subset (D28Pelsubcluster, idents = c("N8","N9","N10","N11","N12"))
InfectedPevlRegionD28Spatial <-SpatialDimPlot(D28Pelsubcluster,label = TRUE, pt.size.factor = 2500)

InfectedPevlRegionD28Spatial
ggsave("Spatial_infectedPelivis_day28_SpatialDimplot.pdf",
      plot = InfectedPevlRegionD28Spatial,
      height = 3,
      width = 4 )

InfectedPevlRegionD28SpatialDim<- DimPlot(D28Pelsubcluster,label = TRUE)
ggsave("Spatial_infectedPelivis_day28_Dimplot.pdf",
      plot = InfectedPevlRegionD28SpatialDim,
      height = 3,
      width = 4 )
InfectedPevlRegionD28SpatialDim
...
CelltypeOrder <- c("PT-S1S2-1","PT-S1S2-2","PT-S3-1","PT-S3-2", "PT-S1S2-N1",  "PT-S1S2-N2","PT-S1S2-N3","InfPT","ProfPT","PC1","PC2","ICA" ,"ICB", "DegCD", "DTL", "TAL","DCT-TAL"  ,"CNT","SMC" ,"URO", "DegURO","FIB" , "END","PL",  "ResMac" , "MONa","MONb", "MACa", "MACb", "NEU"  ,"T" ,"B","NK" )
 ...
 ordered((rownames(D28Pelsubcluster[["predictions"]]@data)),levels =CelltypeOrder)
 
# get the summary of the selected regions
 GetTissueCoordinates(D28Pelsubcluster)
 summary(GetTissueCoordinates(D28Pelsubcluster))
```
# ############################## 
...
D28Pelsubcluster[["predictions"]]
InfectedMat_CorMed<- t(D28Pelsubcluster[["predictions"]]@data)
...
ggsave("SpatialScatterPieInfectedPevl_CorrelationMatrix.pdf", plot =InfectedMat_CorMedCellTypeCorrelationMatrix, height = 6, width = 6 )

ggsave("SpatialScatterPieInfectedPevl_HeatmapColocalization.pdf", plot =InfectedMat_CorMedCellTypeInteractions, height = 6, width = 6 )
# scatterpie plot
# scatterpie plot
# 
...
names(pal) <- ct
#pal
rownames(D28Pelsubcluster)
colnames(D28Pelsubcluster)
str(D28Pelsubcluster)
...
SpatialScatterPieCorMed <-plotSpatialScatterpie(
  ...
  cell_types = colnames(InfectedMat_CorMedCellType),
    ...
    scale_fill_manual(
        values = pal,
        breaks = names(pal)) + coord_sf(xlim = c(220,300), ylim = c(120, 270))

SpatialScatterPieCorMed
# slice9_imagerow >300 & slice9_imagerow <480 )  & (slice9_imagecol < 300 & slice9_imagecol> 220
#(slice9_imagerow >100 & slice9_imagerow <330 )  & (slice9_imagecol < 500 & slice9_imagecol> 280))
ggsave("SpatialScatterPieCorMed.pdf",plot = SpatialScatterPieCorMed, height = 3,width = 5.5)
...
Seurat::SpatialDimPlot(D28Pelsubcluster,pt.size.factor = 1500)
# Prepare input data for CelChat analysis
data.input = Seurat::GetAssayData(D28Pelsubcluster, slot = "data", assay = "SCT") # normalized data matrix
#> Warning: The `slot` argument of `GetAssayData()` is deprecated as of SeuratObject 5.0.0.
Seurat::Idents(D28Pelsubcluster)
...
meta = data.frame(labels = Seurat::Idents(D28Pelsubcluster), samples = "sample1", row.names = names(Seurat::Idents(D28Pelsubcluster))) # manually create a dataframe consisting of the cell labels
meta
...
spatial.locs = Seurat::GetTissueCoordinates(D28Pelsubcluster, scale = NULL, cols = c("imagerow", "imagecol")) 
...
scalefactors = jsonlite::fromJSON(txt = file.path("/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Datasets/VisiumRun1/Acute_chronic_pyelo/seurat", 'scalefactors_json.json'))
...
pdf(file="Spatial_D28_Pelvic_netVisual_circle_strength.pdf",height = 5, width = 4)
netVisual_circle(cellchat@net$weight, vertex.weight = rowSums(cellchat@net$weight), weight.scale = T, label.edge= F, title.name = "Interaction weights/strength")
dev.off()
#library(ComplexHeatmap)
pdf(file="Spatial_D28_Pelvic_NetVisual_interaction_counts.pdf",height = 5, width = 4)
...
# save t
pdf(file="Spatial_D28_Pelvic_TNFSignalingNetVisual.pdf",height = 7, width = 5)
...
CandidatePathways<- c("CXCL","CCL","TNF","IL1","IL2","IL4","IL6")
pdf(file="Spatial_D28_Pelvic_TNFSignalingNetVisual.pdf",height = 5.5, width = 4)
netAnalysis_contribution(cellchat, signaling = CandidatePathways)
dev.off()
#saveRDS(cellchat, file = "cellchat_Spatial_D28_Pelvic.rds")


# read the cell chat object
cellchat <- readRDS("cellchat_Spatial_D28_Pelvic.rds")
pdf(file="Spatial_D28_Pelvic_InnateImmuneSignalingnetVisual_bubble.pdf",height = 5.5, width = 4)
netVisual_bubble(cellchat, sources.use = 4, signaling = CandidatePathways, remove.isolate = FALSE)
dev.off()

# For the TNF signaling
pdf(file="patial_D28_Pelvic_TnfspatialFeature.pdf",height = 4.5, width = 4)
spatialFeaturePlot(cellchat, features = c("Tnf","Tnfrsf1a"), point.size = 1.2, color.heatmap = "Reds", direction = 1)
dev.off()

pdf(file="patial_D28_Pelvic_Il1bspatialFeature.pdf",height = 4.5, width = 4)
...
DefaultAssay(D28Pelsubcluster) <-"SCT"
Finalcelltypemarkers<- c("Lrp2","Slc34a1","Slc13a3", # Proximal tubule cells (PT)
 ...
 for (i in Finalcelltypemarkers){
   CellTypeMarkerSpatialFeature<- SpatialFeaturePlot(D28Pelsubcluster, features = i, pt.size.factor = 6000, crop = TRUE)
...
? FindAllMarkers
D28Pelsubcluster <- ScaleData(object = D28Pelsubcluster, features = rownames(D28Pelsubcluster))
# MAST was used to calculate the cluster
CorMed_nichesBiomarkers <-
  FindAllMarkers(
    object = D28Pelsubcluster,
...
CorMed_nichesBiomarkersTop5Heatmap<- DoHeatmap(D28Pelsubcluster, features = CorMed_nichesBiomarkersTop5 , slot = "scale.data") + scale_fill_gradientn(colors = c("blue", "white", "red")) + theme(axis.text.y = element_text(size = 10))
ggsave(
...
CorMedCorMedPTSubBiomarkersTop5DotPlot <-
  DotPlot(D28Pelsubcluster, features = CorMed_nichesBiomarkersTop5 %>% unique()) +
  RotatedAxis()
...
for (i in Top5PTMarker) {
  ...
  PTmarkerSpatialFeature <-
    SpatialFeaturePlot(D28Pelsubcluster, features = i, slot = "scale.data",pt.size.factor = 4)
...
Idents(D28Pelsubcluster)
for (n in Idents(D28Pelsubcluster)) {
...
CorMedCluster<- data.frame(Cell = names(Idents(D28Pelsubcluster)),   
                              CellType = as.character(Idents(D28Pelsubcluster)),
                              stringsAsFactors = FALSE)

?progeny
D28Pelsubcluster <- progeny(D28Pelsubcluster, scale=FALSE, organism="Mouse", top=500, perm=1, return_assay = TRUE,assay_name = "SCT")
D28Pelsubcluster
# setup the default assay as progeny
DefaultAssay(object = D28Pelsubcluster) <- "progeny"

D28Pelsubcluster <- Seurat::ScaleData(D28Pelsubcluster, assay = "progeny") 
## We can now directly apply Seurat functions in our Progeny scores. 
## For instance, we scale the pathway activity scores. 
progeny_scores_df <- 
  as.data.frame(t(GetAssayData(D28Pelsubcluster, slot = "scale.data", 
                               assay = "progeny"))) %>%
...
progeny_hmap
dev.off()
test<- FeaturePlot(D28Pelsubcluster, features = "NFkB")
...
for (i in ProgenyFeatures ){
  p2 <-(FeaturePlot(D28Pelsubcluster, features = i) & 
  scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red'))& 
  ggtitle(paste0(i," activity"))
  
  ggsave(paste0(i, "_CorMedInfected_cluster_featurePlot.pdf"), plot = p2, width = 6, height = 6)
  
  p3 <- (SpatialFeaturePlot(D28Pelsubcluster, features = i, pt.size.factor = 4) +ggtitle(paste0(i," activity")))
...
D28Pelsubcluster@assays$SCT@data %>% head()
mat <- as.matrix(D28Pelsubcluster@assays$SCT@data)
# Run ulm
...
# Change assay
DefaultAssay(object = D28Pelsubcluster) <- "tfsulm"

# Scale the data
D28Pelsubcluster <- ScaleData(D28Pelsubcluster)
D28Pelsubcluster@assays$tfsulm@data <- D28Pelsubcluster@assays$tfsulm@scale.data

# Explore the top 20 more varaible TFs
n_tfs <- 20

t(as.matrix(D28Pelsubcluster@assays$tfsulm@data))
# Extract activities from object as a long dataframe
df <- t(as.matrix(D28Pelsubcluster@assays$tfsulm@data)) %>%
  as.data.frame() %>%
  mutate(cluster = Idents(D28Pelsubcluster)) %>%
...
for (m in tfs){
  p2 <- (SpatialFeaturePlot(D28Pelsubcluster, features = m,pt.size.factor = 4) +
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
...
D28Pelsubcluster
DefaultAssay(object = D28Pelsubcluster) <- "SCT"

for (n in tfs){
  p3 <- (FeaturePlot(D28Pelsubcluster, features = n,slot= "scale.data") + 
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression')))
  
  p4 <- (SpatialFeaturePlot(D28Pelsubcluster, features = n, pt.size.factor = 4, slot= "scale.data") +
 # scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression (time)')))
 
  ggsave(paste0("TFExpression_",n,"_D28Pelsubcluster_FeaturePlot.pdf"), plot = p3, width = 6, height = 6)
  ggsave(paste0("TFExpression_",n,"_D28Pelsubcluster_SpatilFeaturePlot.pdf"), plot = p4, width = 6, height = 6)
...
GeneOrderByPheatmap
?DotPlot
TFDotPlot <- DotPlot(D28Pelsubcluster, features = rev(GeneOrderByPheatmap)) +
...
```{r}
DefaultAssay(D28Pelsubcluster) <- "SCT"
D28Pelsubcluster@meta.data %>% head()
#Idents(D28Pelsubcluster) <- D28Pelsubcluster@meta.data$Sub2

# reset the identity, Combine the PT cells

Idents(D28Pelsubcluster)
D28Pelsubcluster@meta.data
# adjust the levels
# Idents(D28Pelsubcluster) <-
# ordered(factor(Idents(D28Pelsubcluster)), levels=c( "5_1","10_1","10_0","2_1","2_0","5_0","5_2","4","7","0","1","9","6","3","8"))

levels(Idents(D28Pelsubcluster))
```
...
D28Pelsubcluster = alias_to_symbol_seurat(D28Pelsubcluster, "mouse")

D28Pelsubcluster@meta.data %>% head()
D28Pelsubcluster@meta.data$IntegrateAnnot %>% table() 

head(weighted_networks$gr) 
DimPlot(D28Pelsubcluster)

# If you use convert_to_alias before here, this one won't work
D28Pelsubcluster = Seurat::PrepSCTFindMarkers(D28Pelsubcluster, assay = "SCT", verbose = FALSE)
...
lr_network %>% head()
D28Pelsubcluster %>% subset(features = lr_network$ligand %>% intersect(rownames(D28Pelsubcluster)))
# calcualte the niches difference 
DE_sender = nichenetr::calculate_niche_de(seurat_obj  = D28Pelsubcluster %>% subset(features = lr_network$ligand %>% intersect(rownames(D28Pelsubcluster))), niches = niches, type = "sender", assay_oi = "SCT") # only ligands important for sender cell types
DE_receiver = nichenetr::calculate_niche_de(seurat_obj  = D28Pelsubcluster %>% subset(features = lr_network$receptor %>% unique()), niches = niches, type = "receiver", assay_oi = "SCT") # only receptors now, later on: DE analysis to find targets
...
DE_receiver_targets = nichenetr::calculate_niche_de_targets(seurat_obj = D28Pelsubcluster, niches = niches, lfc_cutoff = lfc_cutoff, expression_pct = expression_pct, assay_oi = "SCT") 
...
avg_expression_ligands = AverageExpression(D28Pelsubcluster, features = nichenet_output$top_ligands)
...
ggsave("SpatialScatterPieday28_CorrelationMatrix.pdf", plot =InfectedMat_D7CellTypeCorrelationMatrix, height = 6, width = 6 )

ggsave("SpatialScatterPieday28_HeatmapColocalization.pdf", plot =InfectedMat_D7CellTypeInteractions, height = 6, width = 6 )
# scatterpie plot
# scatterpie plot
# 
...
#SPOTlight:::. extract_image(Pyelonephritis_Infection )
#rownames(Pyelonephritis_Infection)
SpatialScatterPieday28 <-plotSpatialScatterpie(
...
ggsave("SpatialScatterPieday28.pdf",plot = SpatialScatterPieday28, height = 4,width = 5)
# colnames(DeconvolutedMatrix)
# ncol(Pyelonephritis_Infection)
# nrow(DeconvolutedMatrix)
InfectedMat_D7CellType
pdf(file = "SpatialScatterPieday28_CellTypeNetwork.pdf", height = 8,width = 8)
...
for (i in Finalcelltypemarkers){
  ...
  ggsave(filename = paste0(i,"_SpatialFeaturePrediction_day28.pdf"), plot = CellTypeMarkerSpatialFeature, height = 5, width = 5)
...
# we generate pie plot for day28
```{r}
# set up the day 7
setwd(InfCPiedir)
Pyelonephritis_Infection$orig.ident
...
# we generate pie plot for day28 under infection regions for the CorMed abscess regions
```{r}
setwd(InfCorMeddir)
Pyelonephritis_Infection$orig.ident
Pyelonephritis_InfectionSubslidesD28 <-
...
D28Pelsubcluster <- subset (Pyelonephritis_InfectionSubslidesD28, slice8_imagerow > 140 | slice8_imagecol > 200, invert = TRUE)
D28Pelsubcluster <- subset (D28Pelsubcluster, idents = c("N13","N14","N15","N16","N17"))
InfectedPevlRegionD1Spatial <-SpatialDimPlot(D28Pelsubcluster,crop = TRUE, label = FALSE)
InfectedPevlRegionD1Spatial
ggsave("Spatial_infected_day28_SpatialDimplot.pdf",
      plot = InfectedPevlRegionD1Spatial,
      height = 3,
      width = 4.5 )

Pyelonephritis_InfectionSubslidesD28@meta.data[,c("orig.ident","Annotation")]
## merge is way too troublesome, therefore
FinalIntergratedTableAbcess<- merge(D28Pelsubcluster@meta.data[,c("orig.ident","Annotation")], t(D28Pelsubcluster[["predictions"]]@data), all=TRUE, by="row.names") 
?Heatmap
col_fun <- circlize::colorRamp2(c(0, 0.01, 1), c("white", "blue", "red"))

# generate the mean value for each column
pdf(file = "Spatial_infected_day28_FinalIntergratedTableAbcessHeatmap.pdf", height = 4, width = 4)
...
pal <- colorRampPalette(paletteMartin)(length(ct))
names(pal) <- ct
D28PelsubclusterCellTypeMatrix <-t(D28Pelsubcluster[["predictions"]]@data)

D28PelsubclusterCellTypeMatrixNoMax <- D28PelsubclusterCellTypeMatrix[,!colnames(D28PelsubclusterCellTypeMatrix) %in% c("max")]
D28PelsubclusterCellTypeMatrixNoMax
# generate the scatter pie plot
colnames(D28PelsubclusterCellTypeMatrixNoMax)
#D0subclusterCellTypeMatrixNoMax[D0subclusterCellTypeMatrixNoMax < 0.1] <- 0
InfectedPevlRegionD1SpatialPie<- plotSpatialScatterpie(
  x= D28Pelsubcluster,
  y= D28PelsubclusterCellTypeMatrixNoMax,
  cell_types = colnames(D28PelsubclusterCellTypeMatrixNoMax),
    img = TRUE,
    scatterpie_alpha = 1,
...
?plotSpatialScatterpie
ggsave("Spatial_infected_day28_SpatialCellType_Scatterpie.pdf",
      plot = InfectedPevlRegionD1SpatialPie,
      height = 3,
      width = 4.5 )

# correlation
InfectedPevlRegionD1SpatialPieCorrelationMatrix <- plotCorrelationMatrix(D28PelsubclusterCellTypeMatrixNoMax)
ggsave("Spatial_infected_day28_InfectedPevlRegionD1SpatialPieCorrelationMatrix.pdf",
      plot = InfectedPevlRegionD1SpatialPieCorrelationMatrix,
      height = 4.5,
      width = 4.5 )
# we only select the matrix that rowsum >0
D28PelsubclusterCellTypeMatrixNoMaxLarger<- D28PelsubclusterCellTypeMatrixNoMax[,colSums(D28PelsubclusterCellTypeMatrixNoMax[])>0]
InfectedPevRegionD1Interactions<- plotInteractions(D28PelsubclusterCellTypeMatrixNoMaxLarger, "heatmap") + scale_fill_gradientn(colors = c("blue", "white", "red"))
?plotInteractions
ggsave("Spatial_infected_day28_InfectedPevRegionD1Interactions.pdf",
...
D28Pelsubcluster <- subset (Pyelonephritis_InfectionSubslidesD28, (slice8_imagerow >310 & slice8_imagerow <450 )  & (slice8_imagecol < 330 & slice8_imagecol> 220) )
D28Pelsubcluster <- subset (D28Pelsubcluster, idents = c("N8","N10","N11","N12","N15"))
InfectedPevlRegionD1Spatial <-SpatialDimPlot(D28Pelsubcluster,label = TRUE)
InfectedPevlRegionD1Spatial
ggsave("Spatial_infected_day28_SpatialDimplot.pdf",
      plot = InfectedPevlRegionD1Spatial,
      height = 3,
...
InfectedPevlRegionD1Spatial
D28Pelsubcluster
DefaultAssay(D28Pelsubcluster) <- "integrated"
nbs_2.markers <- FindAllMarkers(D28Pelsubcluster,test.use ="MAST")
nbs_2.markers
??SubsetSTData
#nbs_2.markers$gene <- rownames(nbs_2.markers)

nbs_2.markers
#se.subset <- SubsetSTData(D28Pelsubcluster, expression = nbs_2 %in% c("N12", "N15"))
...
DotPlot(D28Pelsubcluster, features = sorted.marks$gene %>% unique()) +RotatedAxis()
#DoHeatmap(D28Pelsubcluster, features = sorted.marks$gene, group.colors = c("red", "lightgray"))
