...
date: "2024-08-21"
Description: 
#   This script is to profile the all the regions at Day 7
...
# Output directory :
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/"

# Cell types deconvolution:

CDecodir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/Deconvolution/"

# BasicSpatialDim

CAbdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/BasicSpatialDim/"

# Biomarkers
CBiomadir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/CellTypesBiomarkers/"


CDEGdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/DEGs/"

# GOEnrichment

CGOEndir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/GOenrich/"

# Progeny
CProgenydir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/Progeny/"

# Transcript factor
CTFdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/TranscriptFactors/"

# Niche niche Communication

CNichComdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/NicheCommunicate/"

# Concentrate on the infection area abscess from CorMed

InfCorMeddir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay0/"
...
Pyelonephritis_InfectionSubslidesD0Infected<- subset (Pyelonephritis_InfectionSubslidesD0, idents = c("N12","N13","N14","N15","N16","N17"))

InfectedRegionsSpatialDimPlot<-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD0Infected,pt.size.factor = 1500)
ggsave("Pyelonephritis_InfectionSubslidesD0Infected_SpatialDimplot.pdf", plot = InfectedRegionsSpatialDimPlot, height = 4, width = 4)
...
InfectedCorMedRegionD7Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD0,label = TRUE, pt.size.factor =1600)
 ?SpatialDimPlot
...
# InfectedCorMedRegionD7SpatialDim<- DimPlot(Pyelonephritis_InfectionSubslidesD0,label = TRUE)
...
# the prediction of the object
Pyelonephritis_InfectionSubslidesD0[["predictions"]]
InfectedMat_D7<- t(Pyelonephritis_InfectionSubslidesD0[["predictions"]]@data)
...
SpatialD7MarkersDotPlot<- DotPlot(Pyelonephritis_InfectionSubslidesD0, features = Finalcelltypemarkers,cols = "Spectral", dot.scale = 4) +RotatedAxis() +theme(legend.text = element_text(size = 12), legend.title = element_text(size = 8))
