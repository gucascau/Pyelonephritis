...
write.csv(NichesExp, file = "Day5_niches_geneExpr.csv")
...
InfectedRegionsSpatialDimPlot<-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28Infected,pt.size.factor = 1500)
...
ggsave("Spatial_infectedPelivis_day7_SpatialDimplot.pdf",
