...
# Output directory :
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/"

# Cell types deconvolution:

CDecodir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/Deconvolution/"

# BasicSpatialDim

CAbdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/BasicSpatialDim/"

# Biomarkers
CBiomadir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/CellTypesBiomarkers/"


CDEGdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/DEGs/"

# GOEnrichment

CGOEndir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/GOenrich/"

# Progeny
CProgenydir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/Progeny/"

# Transcript factor
CTFdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/TranscriptFactors/"

# Niche niche Communication

CNichComdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/NicheCommunicate/"

# Concentrate on the infection area abscess from CorMed

InfCorMeddir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay28/"
...
Pyelonephritis_InfectionSubslidesD28 <-
    subset (Pyelonephritis_Infection, orig.ident == "PyeloD28_1")
#names(Pyelonephritis_InfectionSubslidesD28@images)
  # there seems to be an error in the susetting, so we removed other igmages
  #names(Pyelonephritis_InfectionSubslides@images)
SelectedImageName <- names(Pyelonephritis_InfectionSubslidesD28@images)
SelectedImageName
OtherImages <- Allimagmes[Allimagmes != SelectedImageName]
OtherImages
Pyelonephritis_InfectionSubslidesD28@images[OtherImages] = NULL
Pyelonephritis_InfectionSubslidesD28@meta.data %>% head()
# for a specific regions and specific clusters
# get the coordate of these cluster
coords <- GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD28)
coords %>% head()
Pyelonephritis_InfectionSubslidesD28@meta.data %>% head()
summary(coords)
Pyelonephritis_InfectionSubslidesD28@images$slice8

SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28,pt.size.factor = 1500)
DefaultAssay(Pyelonephritis_InfectionSubslidesD28) <-"Spatial"

# check the average expression of each cluster
DefaultAssay(Pyelonephritis_InfectionSubslidesD28) <-"SCT"
Pyelonephritis_InfectionSubslidesD28@meta.data
cluster_averages<-AverageExpression(Pyelonephritis_InfectionSubslidesD28, group.by = "Annotation")

# generate the gene expression profiles from each niches
NichesExp<- cluster_averages$SCT

write.csv(NichesExp, file = "Day28_niches_geneExpr.csv")
# we only select the niches the selected niches
Idents(Pyelonephritis_InfectionSubslidesD28)
Pyelonephritis_InfectionSubslidesD28Infected<- subset (Pyelonephritis_InfectionSubslidesD28, idents = c("N12","N13","N14","N15","N16","N17"))

InfectedRegionsSpatialDimPlot<-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28Infected,pt.size.factor = 1000, crop=FALSE)
InfectedRegionsSpatialDimPlot
?SpatialDimPlot
ggsave("Pyelonephritis_InfectionSubslidesD28Infected_SpatialDimplot.pdf", plot = InfectedRegionsSpatialDimPlot, height = 4, width = 4)
# we define the overall regions

# we then select the regions for the cluster : , invert = TRUE
# Pyelonephritis_InfectionSubslidesD28 <- subset (Pyelonephritis_InfectionSubslidesD28,slice8_imagerow > 270 | slice8_imagecol > 270, invert = TRUE)
# SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28, pt.size.factor = 1500)
# Pyelonephritis_InfectionSubslidesD28 <- subset (Pyelonephritis_InfectionSubslidesD28, idents = c("N13","N14","N15","N16","N17"))
InfectedCorMedRegionD7Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28,label = TRUE, pt.size.factor =1600)
 ?SpatialDimPlot
InfectedCorMedRegionD7Spatial
ggsave("Spatial_infectedPelivis_day28_SpatialDimplot.pdf",
      plot = InfectedCorMedRegionD7Spatial,
      height = 8,
      width = 8 )

# InfectedCorMedRegionD7SpatialDim<- DimPlot(Pyelonephritis_InfectionSubslidesD28,label = TRUE)
# ggsave("Spatial_infectedPelivis_day7_Dimplot.pdf",
#       plot = InfectedCorMedRegionD7SpatialDim,
#       height = 3,
#       width = 4 )
# InfectedCorMedRegionD7SpatialDim
...
# 
# 
#  ordered((rownames(Pyelonephritis_InfectionSubslidesD28[["predictions"]]@data)),levels =CelltypeOrder)
#  
# get the summary of the selected regions
 GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD28)
 summary(GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD28))
```
# ############################## 
...
Pyelonephritis_InfectionSubslidesD28[["predictions"]]
InfectedMat_CorMed<- t(Pyelonephritis_InfectionSubslidesD28[["predictions"]]@data)
...
names(pal) <- ct
#pal
rownames(Pyelonephritis_InfectionSubslidesD28)
colnames(Pyelonephritis_InfectionSubslidesD28)
str(Pyelonephritis_InfectionSubslidesD28)
...
SpatialScatterPieCorMed <-plotSpatialScatterpie(
  x= Pyelonephritis_InfectionSubslidesD28,
...
Seurat::SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28,pt.size.factor = 1500)
# Prepare input data for CelChat analysis
data.input = Seurat::GetAssayData(Pyelonephritis_InfectionSubslidesD28, slot = "data", assay = "SCT") # normalized data matrix
#> Warning: The `slot` argument of `GetAssayData()` is deprecated as of SeuratObject 5.0.0.
Seurat::Idents(Pyelonephritis_InfectionSubslidesD28)
...
meta = data.frame(labels = Seurat::Idents(Pyelonephritis_InfectionSubslidesD28), samples = "sample1", row.names = names(Seurat::Idents(Pyelonephritis_InfectionSubslidesD28))) # manually create a dataframe consisting of the cell labels
meta
...
spatial.locs = Seurat::GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD28, scale = NULL, cols = c("imagerow", "imagecol")) 
...
pdf(file="Spatial_D28_Overall_netVisual_circle_strength.pdf",height = 5, width = 4)
netVisual_circle(cellchat@net$weight, vertex.weight = rowSums(cellchat@net$weight), weight.scale = T, label.edge= F, title.name = "Interaction weights/strength")
dev.off()
#library(ComplexHeatmap)
pdf(file="Spatial_D28_Overall_NetVisual_interaction_counts.pdf",height = 5, width = 4)
...
pathways.show <- c("TNF","CCL","CXCL","IL1","IL2","IL4","IL12","IL16")
par(mfrow=c(1,1), xpd = TRUE) # `xpd = TRUE` should be added to show the title
# save t
pdf(file="Spatial_D28_Overall_TNFSignalingNetVisual.pdf",height = 7, width = 5)
...
dev.off()
CandidatePathways<- c("TNF","CCL","CXCL","IL1","IL2","IL4","IL12","IL16")
#CandidatePathways <-cellchat@netP$pathways

pdf(file="Spatial_D28_Overall_InnateImmuneSignalingNetVisual.pdf",height = 6, width = 4)
...
RequestedClusters<- levels(Idents(Pyelonephritis_InfectionSubslidesD28))
RequestedClusters
...
ClsContributionPair
# save the pairs
ggsave("Spatial_D28_Overall_BarplotClsContributionPair.pdf", plot = ClsContributionPair, height = 5, width = 10)
...
ClsContributionPair
# save the pairs
ggsave("Spatial_D28_Overall_BarplotClsContributionPair_Infected.pdf", plot = LimitedClsContributionPair, height = 5, width = 10)
...
ggsave("Spatial_D28_Overall_BarplotClsContributionPair_Infected_heatmap.pdf", plot = LimitedClsContributionPairHeatmap, height = 4, width = 8)

saveRDS(cellchat, file = "cellchat_Spatial_D28_Overall.rds")
...
cellchat@net$prob
#cellchat <- readRDS("cellchat_Spatial_D28_Overall.rds")
pdf(file="Spatial_D28_Overall_InnateImmuneSignalingnetVisual_bubble.pdf",height = 8, width = 12)
netVisual_bubble(cellchat,  signaling = CandidatePathways, remove.isolate = FALSE)
dev.off()
cellchat@net
# Only for N11,N12, N13, N14, N15,N16,N17
pdf(file="Spatial_D28_Targets_Overall_InnateImmuneSignalingnetVisual_bubble.pdf",height = 8, width = 12)
...
pdf(file="Spatial_D28_Overall_TnfspatialFeature.pdf",height = 4.5, width = 4)
spatialFeaturePlot(cellchat, features = c("Tnf","Tnfrsf1a"), point.size = 1.2, color.heatmap = "Reds", direction = 1)
dev.off()


pdf(file="Spatial_D28_Overall_CspatialFeature.pdf",height = 4.5, width = 4)
spatialFeaturePlot(cellchat, features = c("Tnf","Tnfrsf1a"), point.size = 1.2, color.heatmap = "Reds", direction = 1)
dev.off()
pdf(file="Spatial_D28_Overall_Il1bspatialFeature.pdf",height = 4.5, width = 4)
...
pdf(file="Spatial_D28_Overall_outgoincome.pdf",height = 5, width = 12)
ht1+ht2
dev.off()

# we plot the CXCL for vlnPlot
pdf(file="Spatial_D28_Overall_outgoincome_Violn_CCL.pdf",height = 15, width = 9)

plotGeneExpression(cellchat, signaling = c("CCL"), enriched.only = TRUE, type = "violin")
dev.off()
pdf(file="Spatial_D28_Overall_outgoincome_Violn_TNF.pdf",height = 6, width = 9)

plotGeneExpression(cellchat, signaling = c("TNF"), enriched.only = TRUE, type = "violin")
dev.off()

pdf(file="Spatial_D28_Overall_outgoincome_Violn_CXCL.pdf",height = 9, width = 9)
...
Finalcelltypemarkers<- c("Lrp2","Slc34a1","Slc13a3", # Proximal tubule cells (PT)
 ...
 for (i in Finalcelltypemarkers){
   CellTypeMarkerSpatialFeature<- SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = i, pt.size.factor = 6000, crop = TRUE)
...
? FindAllMarkers
Pyelonephritis_InfectionSubslidesD28 <- ScaleData(object = Pyelonephritis_InfectionSubslidesD28, features = rownames(Pyelonephritis_InfectionSubslidesD28))
# MAST was used to calculate the cluster
CorMed_nichesBiomarkers <-
  FindAllMarkers(
    object = Pyelonephritis_InfectionSubslidesD28,
...
CorMed_nichesBiomarkersTop5Heatmap<- DoHeatmap(Pyelonephritis_InfectionSubslidesD28, features = CorMed_nichesBiomarkersTop5 , slot = "scale.data") + scale_fill_gradientn(colors = c("blue", "white", "red")) + theme(axis.text.y = element_text(size = 10))
ggsave(
...
CorMedCorMedPTSubBiomarkersTop5DotPlot <-
  DotPlot(Pyelonephritis_InfectionSubslidesD28, features = CorMed_nichesBiomarkersTop5 %>% unique()) +
  RotatedAxis()
...
for (i in Top5PTMarker) {
  ...
  PTmarkerSpatialFeature <-
    SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = i, slot = "scale.data",pt.size.factor = 4)
...
Idents(Pyelonephritis_InfectionSubslidesD28)
for (n in Idents(Pyelonephritis_InfectionSubslidesD28)) {
...
CorMedCluster<- data.frame(Cell = names(Idents(Pyelonephritis_InfectionSubslidesD28)),   
                              CellType = as.character(Idents(Pyelonephritis_InfectionSubslidesD28)),
                              stringsAsFactors = FALSE)

?progeny
Pyelonephritis_InfectionSubslidesD28 <- progeny(Pyelonephritis_InfectionSubslidesD28, scale=FALSE, organism="Mouse", top=500, perm=1, return_assay = TRUE,assay_name = "SCT")
Pyelonephritis_InfectionSubslidesD28
# setup the default assay as progeny
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD28) <- "progeny"

Pyelonephritis_InfectionSubslidesD28 <- Seurat::ScaleData(Pyelonephritis_InfectionSubslidesD28, assay = "progeny") 
## We can now directly apply Seurat functions in our Progeny scores. 
## For instance, we scale the pathway activity scores. 
progeny_scores_df <- 
  as.data.frame(t(GetAssayData(Pyelonephritis_InfectionSubslidesD28, slot = "scale.data", 
                               assay = "progeny"))) %>%
...
progeny_hmap
dev.off()
test<- FeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = "NFkB")
...
for (i in ProgenyFeatures ){
  p2 <-(FeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = i) & 
  scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red'))& 
  ggtitle(paste0(i," activity"))
  
  ggsave(paste0(i, "_CorMedInfected_cluster_featurePlot.pdf"), plot = p2, width = 6, height = 6)
  
  p3 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = i, pt.size.factor = 4) +ggtitle(paste0(i," activity")))
...
Pyelonephritis_InfectionSubslidesD28@assays$SCT@data %>% head()
mat <- as.matrix(Pyelonephritis_InfectionSubslidesD28@assays$SCT@data)
# Run ulm
...
Pyelonephritis_InfectionSubslidesD28[['tfsulm']] <- acts %>%
...
# Change assay
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD28) <- "tfsulm"

# Scale the data
Pyelonephritis_InfectionSubslidesD28 <- ScaleData(Pyelonephritis_InfectionSubslidesD28)
Pyelonephritis_InfectionSubslidesD28@assays$tfsulm@data <- Pyelonephritis_InfectionSubslidesD28@assays$tfsulm@scale.data

# Explore the top 20 more varaible TFs
n_tfs <- 20

t(as.matrix(Pyelonephritis_InfectionSubslidesD28@assays$tfsulm@data))
# Extract activities from object as a long dataframe
df <- t(as.matrix(Pyelonephritis_InfectionSubslidesD28@assays$tfsulm@data)) %>%
  as.data.frame() %>%
  mutate(cluster = Idents(Pyelonephritis_InfectionSubslidesD28)) %>%
...
for (m in tfs){
  p2 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = m,pt.size.factor = 4) +
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
...
Pyelonephritis_InfectionSubslidesD28
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD28) <- "SCT"

for (n in tfs){
  p3 <- (FeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = n,slot= "scale.data") + 
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression')))
  
  p4 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = n, pt.size.factor = 4, slot= "scale.data") +
 # scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression (time)')))
 
  ggsave(paste0("TFExpression_",n,"_Pyelonephritis_InfectionSubslidesD28_FeaturePlot.pdf"), plot = p3, width = 6, height = 6)
  ggsave(paste0("TFExpression_",n,"_Pyelonephritis_InfectionSubslidesD28_SpatilFeaturePlot.pdf"), plot = p4, width = 6, height = 6)
...
GeneOrderByPheatmap
?DotPlot
TFDotPlot <- DotPlot(Pyelonephritis_InfectionSubslidesD28, features = rev(GeneOrderByPheatmap)) +
...
DefaultAssay(Pyelonephritis_InfectionSubslidesD28) <- "SCT"
Pyelonephritis_InfectionSubslidesD28@meta.data %>% head()
#Idents(Pyelonephritis_InfectionSubslidesD28) <- Pyelonephritis_InfectionSubslidesD28@meta.data$Sub2
...
# adjust the levels
# Idents(Pyelonephritis_InfectionSubslidesD28) <-
# ordered(factor(Idents(Pyelonephritis_InfectionSubslidesD28)), levels=c( "5_1","10_1","10_0","2_1","2_0","5_0","5_2","4","7","0","1","9","6","3","8"))

levels(Idents(Pyelonephritis_InfectionSubslidesD28))
```
...
Pyelonephritis_InfectionSubslidesD28 = alias_to_symbol_seurat(Pyelonephritis_InfectionSubslidesD28, "mouse")

Pyelonephritis_InfectionSubslidesD28@meta.data %>% head()
Pyelonephritis_InfectionSubslidesD28@meta.data$IntegrateAnnot %>% table() 

head(weighted_networks$gr) 
DimPlot(Pyelonephritis_InfectionSubslidesD28)

# If you use convert_to_alias before here, this one won't work
Pyelonephritis_InfectionSubslidesD28 = Seurat::PrepSCTFindMarkers(Pyelonephritis_InfectionSubslidesD28, assay = "SCT", verbose = FALSE)
...
lr_network %>% head()
Pyelonephritis_InfectionSubslidesD28 %>% subset(features = lr_network$ligand %>% intersect(rownames(Pyelonephritis_InfectionSubslidesD28)))
# calcualte the niches difference 
DE_sender = nichenetr::calculate_niche_de(seurat_obj  = Pyelonephritis_InfectionSubslidesD28 %>% subset(features = lr_network$ligand %>% intersect(rownames(Pyelonephritis_InfectionSubslidesD28))), niches = niches, type = "sender", assay_oi = "SCT") # only ligands important for sender cell types
DE_receiver = nichenetr::calculate_niche_de(seurat_obj  = Pyelonephritis_InfectionSubslidesD28 %>% subset(features = lr_network$receptor %>% unique()), niches = niches, type = "receiver", assay_oi = "SCT") # only receptors now, later on: DE analysis to find targets
...
DE_receiver_targets = nichenetr::calculate_niche_de_targets(seurat_obj = Pyelonephritis_InfectionSubslidesD28, niches = niches, lfc_cutoff = lfc_cutoff, expression_pct = expression_pct, assay_oi = "SCT") 
...
nichenet_output = nichenet_seuratobj_aggregate(
  seurat_obj = Pyelonephritis_InfectionSubslidesD28, 
  receiver = "PT", 
...
avg_expression_ligands = AverageExpression(Pyelonephritis_InfectionSubslidesD28, features = nichenet_output$top_ligands)
...
Pyelonephritis_InfectionSubslidesD28
  # there seems to be an error in the susetting, so we removed other igmages
  #names(Pyelonephritis_InfectionSubslides@images)
SelectedImageName <- names(Pyelonephritis_InfectionSubslidesD28@images)[1]
SelectedImageName
OtherImages <- Allimagmes[Allimagmes != SelectedImageName]
OtherImages
Pyelonephritis_InfectionSubslidesD28@images[OtherImages] = NULL

#nrow(Pyelonephritis_InfectionSubslidesD28@meta.data )
SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28, crop = T)

# the prediction of the object
Pyelonephritis_InfectionSubslidesD28[["predictions"]]
InfectedMat_D0<- t(Pyelonephritis_InfectionSubslidesD28[["predictions"]]@data)
...
SpatialD0MarkersDotPlot<- DotPlot(Pyelonephritis_InfectionSubslidesD28, features = Finalcelltypemarkers,cols = "Spectral", dot.scale = 4) +RotatedAxis() +theme(legend.text = element_text(size = 12), legend.title = element_text(size = 8))

ggsave("SpatialD0MarkersDotPlot.pdf", plot = SpatialD0MarkersDotPlot, height = 6, width = 14)
Pyelonephritis_InfectionSubslidesD28

for (i in Finalcelltypemarkers){
   CellTypeMarkerSpatialFeature<- SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD28, features = i, pt.size.factor = 1.6, crop = TRUE) 
   #&
...
Pyelonephritis_InfectionSubslidesD28
  # there seems to be an error in the susetting, so we removed other igmages
  #names(Pyelonephritis_InfectionSubslides@images)
SelectedImageName <- names(Pyelonephritis_InfectionSubslidesD28@images)[5]
SelectedImageName
OtherImages <- Allimagmes[Allimagmes != SelectedImageName]
OtherImages
Pyelonephritis_InfectionSubslidesD28@images[OtherImages] = NULL
...
#nrow(Pyelonephritis_InfectionSubslidesD28@meta.data )
Pyelonephritis_InfectionSubslidesD28Dimplot <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28, crop = T)

ggsave("Pyelonephritis_InfectionSubslidesD28Dimplot.pdf", plot =Pyelonephritis_InfectionSubslidesD28Dimplot, height = 6, width = 6 )

# the prediction of the object
Pyelonephritis_InfectionSubslidesD28[["predictions"]]
InfectedMat_D7<- t(Pyelonephritis_InfectionSubslidesD28[["predictions"]]@data)
...
SpatialD7MarkersDotPlot<- DotPlot(Pyelonephritis_InfectionSubslidesD28, features = Finalcelltypemarkers,cols = "Spectral", dot.scale = 4) +RotatedAxis() +theme(legend.text = element_text(size = 12), legend.title = element_text(size = 8))
...
#nrow(Pyelonephritis_InfectionSubslidesD28@meta.data )
SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28)
...
Pyelonephritis_InfectionSubslidesD28 <- subset (Pyelonephritis_InfectionSubslidesD28, slice8_imagerow > 140 | slice8_imagecol > 200, invert = TRUE)
Pyelonephritis_InfectionSubslidesD28 <- subset (Pyelonephritis_InfectionSubslidesD28, idents = c("N13","N14","N15","N16","N17"))
InfectedCorMedRegionD1Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28,crop = TRUE, label = FALSE)
...
Pyelonephritis_InfectionSubslidesD28@meta.data[,c("orig.ident","Annotation")]
## merge is way too troublesome, therefore
FinalIntergratedTableAbcess<- merge(Pyelonephritis_InfectionSubslidesD28@meta.data[,c("orig.ident","Annotation")], t(Pyelonephritis_InfectionSubslidesD28[["predictions"]]@data), all=TRUE, by="row.names") 
?Heatmap
...
pal <- colorRampPalette(paletteMartin)(length(ct))
names(pal) <- ct
Pyelonephritis_InfectionSubslidesD28CellTypeMatrix <-t(Pyelonephritis_InfectionSubslidesD28[["predictions"]]@data)

Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax <- Pyelonephritis_InfectionSubslidesD28CellTypeMatrix[,!colnames(Pyelonephritis_InfectionSubslidesD28CellTypeMatrix) %in% c("max")]
Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax
# generate the scatter pie plot
colnames(Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax)
...
InfectedCorMedRegionD1SpatialPie<- plotSpatialScatterpie(
  x= Pyelonephritis_InfectionSubslidesD28,
  y= Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax,
  cell_types = colnames(Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax),
    img = TRUE,
    scatterpie_alpha = 1,
...
# correlation
InfectedCorMedRegionD1SpatialPieCorrelationMatrix <- plotCorrelationMatrix(Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax)
...
Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMaxLarger<- Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax[,colSums(Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMax[])>0]
InfectedPevRegionD1Interactions<- plotInteractions(Pyelonephritis_InfectionSubslidesD28CellTypeMatrixNoMaxLarger, "heatmap") + scale_fill_gradientn(colors = c("blue", "white", "red"))
?plotInteractions
...
Pyelonephritis_InfectionSubslidesD28 <- subset (Pyelonephritis_InfectionSubslidesD28, (slice8_imagerow >310 & slice8_imagerow <450 )  & (slice8_imagecol < 330 & slice8_imagecol> 220) )
Pyelonephritis_InfectionSubslidesD28 <- subset (Pyelonephritis_InfectionSubslidesD28, idents = c("N8","N10","N11","N12","N15"))
InfectedCorMedRegionD1Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD28,label = TRUE)
InfectedCorMedRegionD1Spatial
ggsave("Spatial_infected_day7_SpatialDimplot.pdf",
      plot = InfectedCorMedRegionD1Spatial,
      height = 3,
...
InfectedCorMedRegionD1Spatial
Pyelonephritis_InfectionSubslidesD28
DefaultAssay(Pyelonephritis_InfectionSubslidesD28) <- "integrated"
nbs_2.markers <- FindAllMarkers(Pyelonephritis_InfectionSubslidesD28,test.use ="MAST")
nbs_2.markers
??SubsetSTData
#nbs_2.markers$gene <- rownames(nbs_2.markers)

nbs_2.markers
#se.subset <- SubsetSTData(Pyelonephritis_InfectionSubslidesD28, expression = nbs_2 %in% c("N12", "N15"))
...
DotPlot(Pyelonephritis_InfectionSubslidesD28, features = sorted.marks$gene %>% unique()) +RotatedAxis()
#DoHeatmap(Pyelonephritis_InfectionSubslidesD28, features = sorted.marks$gene, group.colors = c("red", "lightgray"))
