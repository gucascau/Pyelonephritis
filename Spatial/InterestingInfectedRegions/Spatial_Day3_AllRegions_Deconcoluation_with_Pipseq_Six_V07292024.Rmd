---
title: "Spatial_Day5_AllRegions_Deconcoluation_with_Pipseq_Six_V1012"
...
date: "2024-08-21"
Description: 
#   This script is to profile the all the regions at Day 5
...
# Output directory :
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/"

# Cell types deconvolution:

CDecodir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/Deconvolution/"

# BasicSpatialDim

CAbdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/BasicSpatialDim/"

# Biomarkers
CBiomadir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/CellTypesBiomarkers/"


CDEGdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/DEGs/"

# GOEnrichment

CGOEndir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/GOenrich/"

# Progeny
CProgenydir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/Progeny/"

# Transcript factor
CTFdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/TranscriptFactors/"

# Niche niche Communication

CNichComdir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/NicheCommunicate/"

# Concentrate on the infection area abscess from CorMed

InfCorMeddir ="/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/NichesDEGs_V07292024/OverallDay3/"
...
#dir.create(day3dir, showWarnings = F)
...
Pyelonephritis_InfectionSubslidesD3 <-
    subset (Pyelonephritis_Infection, orig.ident == "PyeloD3_1")
#names(Pyelonephritis_InfectionSubslidesD3@images)
  # there seems to be an error in the susetting, so we removed other igmages
  #names(Pyelonephritis_InfectionSubslides@images)
SelectedImageName <- names(Pyelonephritis_InfectionSubslidesD3@images)
SelectedImageName
OtherImages <- Allimagmes[Allimagmes != SelectedImageName]
OtherImages
Pyelonephritis_InfectionSubslidesD3@images[OtherImages] = NULL
Pyelonephritis_InfectionSubslidesD3@meta.data %>% head()
# for a specific regions and specific clusters
# get the coordate of these cluster
coords <- GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD3)
coords %>% head()
Pyelonephritis_InfectionSubslidesD3@meta.data %>% head()
summary(coords)
Pyelonephritis_InfectionSubslidesD3@images$slice8

SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3,pt.size.factor = 1500)
DefaultAssay(Pyelonephritis_InfectionSubslidesD3) <-"Spatial"

# check the average expression of each cluster
DefaultAssay(Pyelonephritis_InfectionSubslidesD3) <-"SCT"
Pyelonephritis_InfectionSubslidesD3@meta.data
cluster_averages<-AverageExpression(Pyelonephritis_InfectionSubslidesD3, group.by = "Annotation")

# generate the gene expression profiles from each niches
NichesExp<- cluster_averages$SCT

write.csv(NichesExp, file = "Day3_niches_geneExpr.csv")
# we only select the niches the selected niches
Idents(Pyelonephritis_InfectionSubslidesD3)
Pyelonephritis_InfectionSubslidesD3Infected<- subset (Pyelonephritis_InfectionSubslidesD3, idents = c("N12","N13","N14","N15","N16","N17"))

InfectedRegionsSpatialDimPlot<-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3Infected,pt.size.factor = 1500)
InfectedRegionsSpatialDimPlot
ggsave("Pyelonephritis_InfectionSubslidesD3Infected_SpatialDimplot.pdf", plot = InfectedRegionsSpatialDimPlot, height = 4, width = 4)
# we define the overall regions

# we then select the regions for the cluster : , invert = TRUE
# Pyelonephritis_InfectionSubslidesD3 <- subset (Pyelonephritis_InfectionSubslidesD3,slice8_imagerow > 270 | slice8_imagecol > 270, invert = TRUE)
# SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3, pt.size.factor = 1500)
# Pyelonephritis_InfectionSubslidesD3 <- subset (Pyelonephritis_InfectionSubslidesD3, idents = c("N13","N14","N15","N16","N17"))
InfectedCorMedRegionD3Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3,label = TRUE, pt.size.factor =1600)
 ?SpatialDimPlot
InfectedCorMedRegionD3Spatial
ggsave("Spatial_infectedPelivis_day3_SpatialDimplot.pdf",
      plot = InfectedCorMedRegionD3Spatial,
      height = 8,
      width = 8 )

# InfectedCorMedRegionD3SpatialDim<- DimPlot(Pyelonephritis_InfectionSubslidesD3,label = TRUE)
# ggsave("Spatial_infectedPelivis_day3_Dimplot.pdf",
#       plot = InfectedCorMedRegionD3SpatialDim,
#       height = 3,
#       width = 4 )
# InfectedCorMedRegionD3SpatialDim
...
# 
# 
#  ordered((rownames(Pyelonephritis_InfectionSubslidesD3[["predictions"]]@data)),levels =CelltypeOrder)
#  
# get the summary of the selected regions
 GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD3)
 summary(GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD3))
```
# ############################## 
...
Pyelonephritis_InfectionSubslidesD3[["predictions"]]
InfectedMat_CorMed<- t(Pyelonephritis_InfectionSubslidesD3[["predictions"]]@data)
...
names(pal) <- ct
#pal
rownames(Pyelonephritis_InfectionSubslidesD3)
colnames(Pyelonephritis_InfectionSubslidesD3)
str(Pyelonephritis_InfectionSubslidesD3)
...
SpatialScatterPieCorMed <-plotSpatialScatterpie(
  x= Pyelonephritis_InfectionSubslidesD3,
...
Seurat::SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3,pt.size.factor = 1500)
# Prepare input data for CelChat analysis
data.input = Seurat::GetAssayData(Pyelonephritis_InfectionSubslidesD3, slot = "data", assay = "SCT") # normalized data matrix
#> Warning: The `slot` argument of `GetAssayData()` is deprecated as of SeuratObject 5.0.0.
Seurat::Idents(Pyelonephritis_InfectionSubslidesD3)
...
meta = data.frame(labels = Seurat::Idents(Pyelonephritis_InfectionSubslidesD3), samples = "sample1", row.names = names(Seurat::Idents(Pyelonephritis_InfectionSubslidesD3))) # manually create a dataframe consisting of the cell labels
meta
...
spatial.locs = Seurat::GetTissueCoordinates(Pyelonephritis_InfectionSubslidesD3, scale = NULL, cols = c("imagerow", "imagecol")) 
...
pdf(file="Spatial_D3_Overall_netVisual_circle_strength.pdf",height = 5, width = 4)
netVisual_circle(cellchat@net$weight, vertex.weight = rowSums(cellchat@net$weight), weight.scale = T, label.edge= F, title.name = "Interaction weights/strength")
dev.off()
#library(ComplexHeatmap)
pdf(file="Spatial_D3_Overall_NetVisual_interaction_counts.pdf",height = 5, width = 4)
...
pathways.show <- c("TNF","CCL","CXCL","IL1","IL2","IL4","IL6","IL16")
par(mfrow=c(1,1), xpd = TRUE) # `xpd = TRUE` should be added to show the title
# save t
pdf(file="Spatial_D3_Overall_TNFSignalingNetVisual.pdf",height = 7, width = 5)
...
dev.off()
CandidatePathways<- c("TNF","CCL","CXCL","IL1","IL2","IL4","IL6","IL16")
#CandidatePathways <-cellchat@netP$pathways

pdf(file="Spatial_D3_Overall_InnateImmuneSignalingNetVisual.pdf",height = 6, width = 4)
...
RequestedClusters<- levels(Idents(Pyelonephritis_InfectionSubslidesD3))
RequestedClusters
...
ClsContributionPair
# save the pairs
ggsave("Spatial_D3_Overall_BarplotClsContributionPair.pdf", plot = ClsContributionPair, height = 5, width = 10)
...
ClsContributionPair
# save the pairs
ggsave("Spatial_D3_Overall_BarplotClsContributionPair_Infected.pdf", plot = LimitedClsContributionPair, height = 5, width = 10)
...
ggsave("Spatial_D3_Overall_BarplotClsContributionPair_Infected_heatmap.pdf", plot = LimitedClsContributionPairHeatmap, height = 4, width = 8)

saveRDS(cellchat, file = "cellchat_Spatial_D3_Overall.rds")
...
cellchat@net$prob
#cellchat <- readRDS("cellchat_Spatial_D3_Overall.rds")
pdf(file="Spatial_D3_Overall_InnateImmuneSignalingnetVisual_bubble.pdf",height = 8, width = 12)
netVisual_bubble(cellchat,  signaling = CandidatePathways, remove.isolate = FALSE)
dev.off()
cellchat@net
# Only for N11,N12, N13, N14, N15,N16,N17
pdf(file="Spatial_D3_Targets_Overall_InnateImmuneSignalingnetVisual_bubble.pdf",height = 8, width = 12)
...
pdf(file="Spatial_D3_Overall_TnfspatialFeature.pdf",height = 4.5, width = 4)
spatialFeaturePlot(cellchat, features = c("Tnf","Tnfrsf1a"), point.size = 1.2, color.heatmap = "Reds", direction = 1)
dev.off()

pdf(file="Spatial_D3_Overall_Il1bspatialFeature.pdf",height = 4.5, width = 4)
...
pdf(file="Spatial_D3_Overall_outgoincome.pdf",height = 5, width = 12)
ht1+ht2
dev.off()

# we plot the CXCL for vlnPlot
pdf(file="Spatial_D3_Overall_outgoincome_Violn_CCL.pdf",height = 15, width = 9)

plotGeneExpression(cellchat, signaling = c("CCL"), enriched.only = TRUE, type = "violin")
dev.off()
pdf(file="Spatial_D3_Overall_outgoincome_Violn_TNF.pdf",height = 6, width = 9)

plotGeneExpression(cellchat, signaling = c("TNF"), enriched.only = TRUE, type = "violin")
dev.off()

pdf(file="Spatial_D3_Overall_outgoincome_Violn_CXCL.pdf",height = 9, width = 9)
...
Finalcelltypemarkers<- c("Lrp2","Slc34a1","Slc13a3", # Proximal tubule cells (PT)
 ...
 for (i in Finalcelltypemarkers){
   CellTypeMarkerSpatialFeature<- SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = i, pt.size.factor = 6000, crop = TRUE)
...
? FindAllMarkers
Pyelonephritis_InfectionSubslidesD3 <- ScaleData(object = Pyelonephritis_InfectionSubslidesD3, features = rownames(Pyelonephritis_InfectionSubslidesD3))
# MAST was used to calculate the cluster
CorMed_nichesBiomarkers <-
  FindAllMarkers(
    object = Pyelonephritis_InfectionSubslidesD3,
...
CorMed_nichesBiomarkersTop5Heatmap<- DoHeatmap(Pyelonephritis_InfectionSubslidesD3, features = CorMed_nichesBiomarkersTop5 , slot = "scale.data") + scale_fill_gradientn(colors = c("blue", "white", "red")) + theme(axis.text.y = element_text(size = 10))
ggsave(
...
CorMedCorMedPTSubBiomarkersTop5DotPlot <-
  DotPlot(Pyelonephritis_InfectionSubslidesD3, features = CorMed_nichesBiomarkersTop5 %>% unique()) +
  RotatedAxis()
...
for (i in Top5PTMarker) {
  ...
  PTmarkerSpatialFeature <-
    SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = i, slot = "scale.data",pt.size.factor = 4)
...
Idents(Pyelonephritis_InfectionSubslidesD3)
for (n in Idents(Pyelonephritis_InfectionSubslidesD3)) {
...
CorMedCluster<- data.frame(Cell = names(Idents(Pyelonephritis_InfectionSubslidesD3)),   
                              CellType = as.character(Idents(Pyelonephritis_InfectionSubslidesD3)),
                              stringsAsFactors = FALSE)

?progeny
Pyelonephritis_InfectionSubslidesD3 <- progeny(Pyelonephritis_InfectionSubslidesD3, scale=FALSE, organism="Mouse", top=500, perm=1, return_assay = TRUE,assay_name = "SCT")
Pyelonephritis_InfectionSubslidesD3
# setup the default assay as progeny
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD3) <- "progeny"

Pyelonephritis_InfectionSubslidesD3 <- Seurat::ScaleData(Pyelonephritis_InfectionSubslidesD3, assay = "progeny") 
## We can now directly apply Seurat functions in our Progeny scores. 
## For instance, we scale the pathway activity scores. 
progeny_scores_df <- 
  as.data.frame(t(GetAssayData(Pyelonephritis_InfectionSubslidesD3, slot = "scale.data", 
                               assay = "progeny"))) %>%
...
progeny_hmap
dev.off()
test<- FeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = "NFkB")
...
for (i in ProgenyFeatures ){
  p2 <-(FeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = i) & 
  scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red'))& 
  ggtitle(paste0(i," activity"))
  
  ggsave(paste0(i, "_CorMedInfected_cluster_featurePlot.pdf"), plot = p2, width = 6, height = 6)
  
  p3 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = i, pt.size.factor = 4) +ggtitle(paste0(i," activity")))
...
Pyelonephritis_InfectionSubslidesD3@assays$SCT@data %>% head()
mat <- as.matrix(Pyelonephritis_InfectionSubslidesD3@assays$SCT@data)
# Run ulm
...
Pyelonephritis_InfectionSubslidesD3[['tfsulm']] <- acts %>%
...
# Change assay
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD3) <- "tfsulm"

# Scale the data
Pyelonephritis_InfectionSubslidesD3 <- ScaleData(Pyelonephritis_InfectionSubslidesD3)
Pyelonephritis_InfectionSubslidesD3@assays$tfsulm@data <- Pyelonephritis_InfectionSubslidesD3@assays$tfsulm@scale.data

# Explore the top 20 more varaible TFs
n_tfs <- 20

t(as.matrix(Pyelonephritis_InfectionSubslidesD3@assays$tfsulm@data))
# Extract activities from object as a long dataframe
df <- t(as.matrix(Pyelonephritis_InfectionSubslidesD3@assays$tfsulm@data)) %>%
  as.data.frame() %>%
  mutate(cluster = Idents(Pyelonephritis_InfectionSubslidesD3)) %>%
...
for (m in tfs){
  p2 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = m,pt.size.factor = 4) +
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
...
Pyelonephritis_InfectionSubslidesD3
DefaultAssay(object = Pyelonephritis_InfectionSubslidesD3) <- "SCT"

for (n in tfs){
  p3 <- (FeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = n,slot= "scale.data") + 
  #scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression')))
  
  p4 <- (SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = n, pt.size.factor = 4, slot= "scale.data") +
 # scale_colour_gradient2(low = 'blue', mid = 'white', high = 'red')) +
  ggtitle(paste0(n, ' expression (time)')))
 
  ggsave(paste0("TFExpression_",n,"_Pyelonephritis_InfectionSubslidesD3_FeaturePlot.pdf"), plot = p3, width = 6, height = 6)
  ggsave(paste0("TFExpression_",n,"_Pyelonephritis_InfectionSubslidesD3_SpatilFeaturePlot.pdf"), plot = p4, width = 6, height = 6)
...
GeneOrderByPheatmap
?DotPlot
TFDotPlot <- DotPlot(Pyelonephritis_InfectionSubslidesD3, features = rev(GeneOrderByPheatmap)) +
...
DefaultAssay(Pyelonephritis_InfectionSubslidesD3) <- "SCT"
Pyelonephritis_InfectionSubslidesD3@meta.data %>% head()
#Idents(Pyelonephritis_InfectionSubslidesD3) <- Pyelonephritis_InfectionSubslidesD3@meta.data$Sub2
...
# adjust the levels
# Idents(Pyelonephritis_InfectionSubslidesD3) <-
# ordered(factor(Idents(Pyelonephritis_InfectionSubslidesD3)), levels=c( "5_1","10_1","10_0","2_1","2_0","5_0","5_2","4","7","0","1","9","6","3","8"))

levels(Idents(Pyelonephritis_InfectionSubslidesD3))
```
...
Pyelonephritis_InfectionSubslidesD3 = alias_to_symbol_seurat(Pyelonephritis_InfectionSubslidesD3, "mouse")

Pyelonephritis_InfectionSubslidesD3@meta.data %>% head()
Pyelonephritis_InfectionSubslidesD3@meta.data$IntegrateAnnot %>% table() 

head(weighted_networks$gr) 
DimPlot(Pyelonephritis_InfectionSubslidesD3)

# If you use convert_to_alias before here, this one won't work
Pyelonephritis_InfectionSubslidesD3 = Seurat::PrepSCTFindMarkers(Pyelonephritis_InfectionSubslidesD3, assay = "SCT", verbose = FALSE)
...
lr_network %>% head()
Pyelonephritis_InfectionSubslidesD3 %>% subset(features = lr_network$ligand %>% intersect(rownames(Pyelonephritis_InfectionSubslidesD3)))
# calcualte the niches difference 
DE_sender = nichenetr::calculate_niche_de(seurat_obj  = Pyelonephritis_InfectionSubslidesD3 %>% subset(features = lr_network$ligand %>% intersect(rownames(Pyelonephritis_InfectionSubslidesD3))), niches = niches, type = "sender", assay_oi = "SCT") # only ligands important for sender cell types
DE_receiver = nichenetr::calculate_niche_de(seurat_obj  = Pyelonephritis_InfectionSubslidesD3 %>% subset(features = lr_network$receptor %>% unique()), niches = niches, type = "receiver", assay_oi = "SCT") # only receptors now, later on: DE analysis to find targets
...
DE_receiver_targets = nichenetr::calculate_niche_de_targets(seurat_obj = Pyelonephritis_InfectionSubslidesD3, niches = niches, lfc_cutoff = lfc_cutoff, expression_pct = expression_pct, assay_oi = "SCT") 
...
nichenet_output = nichenet_seuratobj_aggregate(
  seurat_obj = Pyelonephritis_InfectionSubslidesD3, 
  receiver = "PT", 
...
avg_expression_ligands = AverageExpression(Pyelonephritis_InfectionSubslidesD3, features = nichenet_output$top_ligands)
...
Pyelonephritis_InfectionSubslidesD3
  # there seems to be an error in the susetting, so we removed other igmages
  #names(Pyelonephritis_InfectionSubslides@images)
SelectedImageName <- names(Pyelonephritis_InfectionSubslidesD3@images)[1]
SelectedImageName
OtherImages <- Allimagmes[Allimagmes != SelectedImageName]
OtherImages
Pyelonephritis_InfectionSubslidesD3@images[OtherImages] = NULL

#nrow(Pyelonephritis_InfectionSubslidesD3@meta.data )
SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3, crop = T)

# the prediction of the object
Pyelonephritis_InfectionSubslidesD3[["predictions"]]
InfectedMat_D0<- t(Pyelonephritis_InfectionSubslidesD3[["predictions"]]@data)
...
SpatialD0MarkersDotPlot<- DotPlot(Pyelonephritis_InfectionSubslidesD3, features = Finalcelltypemarkers,cols = "Spectral", dot.scale = 4) +RotatedAxis() +theme(legend.text = element_text(size = 12), legend.title = element_text(size = 8))

ggsave("SpatialD0MarkersDotPlot.pdf", plot = SpatialD0MarkersDotPlot, height = 6, width = 14)
Pyelonephritis_InfectionSubslidesD3

for (i in Finalcelltypemarkers){
   CellTypeMarkerSpatialFeature<- SpatialFeaturePlot(Pyelonephritis_InfectionSubslidesD3, features = i, pt.size.factor = 1.6, crop = TRUE) 
   #&
...
Pyelonephritis_InfectionSubslidesD3
  # there seems to be an error in the susetting, so we removed other igmages
  #names(Pyelonephritis_InfectionSubslides@images)
SelectedImageName <- names(Pyelonephritis_InfectionSubslidesD3@images)[5]
SelectedImageName
OtherImages <- Allimagmes[Allimagmes != SelectedImageName]
OtherImages
Pyelonephritis_InfectionSubslidesD3@images[OtherImages] = NULL
...
#nrow(Pyelonephritis_InfectionSubslidesD3@meta.data )
Pyelonephritis_InfectionSubslidesD3Dimplot <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3, crop = T)

ggsave("Pyelonephritis_InfectionSubslidesD3Dimplot.pdf", plot =Pyelonephritis_InfectionSubslidesD3Dimplot, height = 6, width = 6 )

# the prediction of the object
Pyelonephritis_InfectionSubslidesD3[["predictions"]]
InfectedMat_D7<- t(Pyelonephritis_InfectionSubslidesD3[["predictions"]]@data)
...
ggsave("SpatialScatterPieday3_CorrelationMatrix.pdf", plot =InfectedMat_D7CellTypeCorrelationMatrix, height = 6, width = 6 )

ggsave("SpatialScatterPieday3_HeatmapColocalization.pdf", plot =InfectedMat_D7CellTypeInteractions, height = 6, width = 6 )
# scatterpie plot
# scatterpie plot
# 
...
#SPOTlight:::. extract_image(Pyelonephritis_Infection )
#rownames(Pyelonephritis_Infection)
SpatialScatterPieday3 <-plotSpatialScatterpie(
  x= Pyelonephritis_InfectionSubslidesD3,
...
ggsave("SpatialScatterPieday3.pdf",plot = SpatialScatterPieday3, height = 4,width = 5)
# colnames(DeconvolutedMatrix)
# ncol(Pyelonephritis_Infection)
# nrow(DeconvolutedMatrix)
InfectedMat_D7CellType
pdf(file = "SpatialScatterPieday3_CellTypeNetwork.pdf", height = 8,width = 8)
...
SpatialD7MarkersDotPlot<- DotPlot(Pyelonephritis_InfectionSubslidesD3, features = Finalcelltypemarkers,cols = "Spectral", dot.scale = 4) +RotatedAxis() +theme(legend.text = element_text(size = 12), legend.title = element_text(size = 8))
...
for (i in Finalcelltypemarkers){
  ...
  ggsave(filename = paste0(i,"_SpatialFeaturePrediction_day3.pdf"), plot = CellTypeMarkerSpatialFeature, height = 5, width = 5)
...
#nrow(Pyelonephritis_InfectionSubslidesD3@meta.data )
SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3)
...
# we generate pie plot for day3 under infection regions for the CorMed abscess regions
```{r}
setwd(InfCorMeddir)
Pyelonephritis_Infection$orig.ident
Pyelonephritis_InfectionSubslidesD3 <-
...
Pyelonephritis_InfectionSubslidesD3 <- subset (Pyelonephritis_InfectionSubslidesD3, slice8_imagerow > 140 | slice8_imagecol > 200, invert = TRUE)
Pyelonephritis_InfectionSubslidesD3 <- subset (Pyelonephritis_InfectionSubslidesD3, idents = c("N13","N14","N15","N16","N17"))
InfectedCorMedRegionD1Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3,crop = TRUE, label = FALSE)
InfectedCorMedRegionD1Spatial
ggsave("Spatial_infected_day3_SpatialDimplot.pdf",
      plot = InfectedCorMedRegionD1Spatial,
      height = 3,
      width = 4.5 )

Pyelonephritis_InfectionSubslidesD3@meta.data[,c("orig.ident","Annotation")]
## merge is way too troublesome, therefore
FinalIntergratedTableAbcess<- merge(Pyelonephritis_InfectionSubslidesD3@meta.data[,c("orig.ident","Annotation")], t(Pyelonephritis_InfectionSubslidesD3[["predictions"]]@data), all=TRUE, by="row.names") 
?Heatmap
col_fun <- circlize::colorRamp2(c(0, 0.01, 1), c("white", "blue", "red"))

# generate the mean value for each column
pdf(file = "Spatial_infected_day3_FinalIntergratedTableAbcessHeatmap.pdf", height = 4, width = 4)
...
pal <- colorRampPalette(paletteMartin)(length(ct))
names(pal) <- ct
Pyelonephritis_InfectionSubslidesD3CellTypeMatrix <-t(Pyelonephritis_InfectionSubslidesD3[["predictions"]]@data)

Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax <- Pyelonephritis_InfectionSubslidesD3CellTypeMatrix[,!colnames(Pyelonephritis_InfectionSubslidesD3CellTypeMatrix) %in% c("max")]
Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax
# generate the scatter pie plot
colnames(Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax)
...
InfectedCorMedRegionD1SpatialPie<- plotSpatialScatterpie(
  x= Pyelonephritis_InfectionSubslidesD3,
  y= Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax,
  cell_types = colnames(Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax),
    img = TRUE,
    scatterpie_alpha = 1,
...
?plotSpatialScatterpie
ggsave("Spatial_infected_day3_SpatialCellType_Scatterpie.pdf",
      plot = InfectedCorMedRegionD1SpatialPie,
      height = 3,
      width = 4.5 )

# correlation
InfectedCorMedRegionD1SpatialPieCorrelationMatrix <- plotCorrelationMatrix(Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax)
ggsave("Spatial_infected_day3_InfectedCorMedRegionD1SpatialPieCorrelationMatrix.pdf",
      plot = InfectedCorMedRegionD1SpatialPieCorrelationMatrix,
      height = 4.5,
      width = 4.5 )
# we only select the matrix that rowsum >0
Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMaxLarger<- Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax[,colSums(Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMax[])>0]
InfectedPevRegionD1Interactions<- plotInteractions(Pyelonephritis_InfectionSubslidesD3CellTypeMatrixNoMaxLarger, "heatmap") + scale_fill_gradientn(colors = c("blue", "white", "red"))
?plotInteractions
ggsave("Spatial_infected_day3_InfectedPevRegionD1Interactions.pdf",
...
Pyelonephritis_InfectionSubslidesD3 <- subset (Pyelonephritis_InfectionSubslidesD3, (slice8_imagerow >310 & slice8_imagerow <450 )  & (slice8_imagecol < 330 & slice8_imagecol> 220) )
Pyelonephritis_InfectionSubslidesD3 <- subset (Pyelonephritis_InfectionSubslidesD3, idents = c("N8","N10","N11","N12","N15"))
InfectedCorMedRegionD1Spatial <-SpatialDimPlot(Pyelonephritis_InfectionSubslidesD3,label = TRUE)
InfectedCorMedRegionD1Spatial
ggsave("Spatial_infected_day3_SpatialDimplot.pdf",
      plot = InfectedCorMedRegionD1Spatial,
      height = 3,
...
InfectedCorMedRegionD1Spatial
Pyelonephritis_InfectionSubslidesD3
DefaultAssay(Pyelonephritis_InfectionSubslidesD3) <- "integrated"
nbs_2.markers <- FindAllMarkers(Pyelonephritis_InfectionSubslidesD3,test.use ="MAST")
nbs_2.markers
??SubsetSTData
#nbs_2.markers$gene <- rownames(nbs_2.markers)

nbs_2.markers
#se.subset <- SubsetSTData(Pyelonephritis_InfectionSubslidesD3, expression = nbs_2 %in% c("N12", "N15"))
...
DotPlot(Pyelonephritis_InfectionSubslidesD3, features = sorted.marks$gene %>% unique()) +RotatedAxis()
#DoHeatmap(Pyelonephritis_InfectionSubslidesD3, features = sorted.marks$gene, group.colors = c("red", "lightgray"))
...
Pyelonephritis_InfectionD0 <- subset(Pyelonephritis_Infection, orig.ident == c("PyeloD5_2"))
...
for (Pdate in Condition){
 ...
 i =i+1
  ...
  #PyeloD5_2_Median_tidy$Value[is.nan(PyeloD5_2_Median_tidy$Value)]<-0
  # ignore the na.omit
