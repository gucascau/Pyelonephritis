...
ggsave(filename = "WithMarkerSelected_CollectingDuctMarkersDotPlot.pdf", plot = CollectingDuctMarkersDotPlot, height = 5, width = 12)
...
#ICPCmarkers <- c("Atp6v1g3","Slc26a4","Hmx2","Spink8","Slc26a7","Aqp6","Slc4a1","Kit","Aqp2","Hsd11b2","Scnn1g")
CollectingDuctMarkersDotPlot2 <- DotPlot(ICPCcells, features = AllKidneymarkers)
CollectingDuctMarkersDotPlot2
ggsave(filename = "WithMarkerSelected_AllMarkersDotPlot.pdf", plot = CollectingDuctMarkersDotPlot, height = 5, width = 12)
```
...
# Reorder the levels:
Idents(ICPCcellsFinal)<-ordered(factor(Idents(ICPCcellsFinal)),levels=c("ICA","ICB","PC"))
...
ggsave(filename = "ICPCcellsFinalDimWithAnno.pdf", plot = ICPCcellsFinalDimWithAnno, width = 5, height =4)

ICPCcellsFinal@meta.data %>% head()
ICPCcellsFinalDimWithAnnoGroup<- DimPlot(ICPCcellsFinal,label = T, split.by = "DataSet")
ICPCcellsFinalDimWithAnnoGroup
ggsave(filename = "ICPCcellsFinalDimWithAnnoGroup.pdf", plot = ICPCcellsFinalDimWithAnnoGroup, width = 12, height =4)
...
ggsave(filename = "ICPCcellsFinalMarkerHeatmapWithAnno.pdf", plot = ICPCcellsFinalMarkerHeatmapWithAnno, width = 5, height =6)
...
ICPCTop5List<- AllClustermarkers %>% group_by(cluster) %>% slice_max(avg_log2FC, n = 10) %>% pull(gene)
ICPCTop5MarkersDotPlot <- DotPlot(ICPCcellsFinal, features =  ICPCTop5List) +RotatedAxis()
ggsave(filename = "ICPCTop10MarkersDotPlot.pdf", plot = ICPCTop5MarkersDotPlot, width = 12, height =4)
...
ggsave(filename = "UniqueGroupPathwayCompareCluster_Dotplot.pdf", plot = UniqueGroupPathwayCompareCluster_Dotplot, width = 8, height = 10)
