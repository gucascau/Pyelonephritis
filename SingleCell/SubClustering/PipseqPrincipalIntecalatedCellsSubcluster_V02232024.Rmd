...
ICPCcells<- FindClusters(ICPCcells,  verbose = TRUE, resolution = 0.2)
...
# check the PC
```{r}
ICPCmarkers <- c("Atp6v1g3","Atp6v1g1","Rcan2","Slc26a4","Hmx2","Spink8","Slc26a7","Aqp6","Slc4a1","Kit","Aqp2","Hsd11b2","Scnn1g")

DotPlot(ICPCcells, features = ICPCmarkers)
```
