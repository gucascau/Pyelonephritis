...
MACcells <- subset(scrna, subset = Raw_cell_type == "MAC" |Raw_cell_type == "B" )
...
ggsave(filename = "MACcellsDimSplit.pdf", plot = MACcellsDimSplit, width = 24, height = 6)
...
# add the frequency of marcrophages
```{r}
