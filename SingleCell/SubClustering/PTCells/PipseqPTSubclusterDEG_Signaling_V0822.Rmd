...
saveRDS(PTcells, file = "PIPSeq_Annotated_OnlyPT_v0823.rds")
...
CandidateMarkersDotPlot<-  DotPlot(PTcells, features =  CandidateMarkers, col.min = -1) +RotatedAxis()
CandidateMarkersDotPlot
ggsave("PT_CandidateMarkersDotPlot.pdf", plot = CandidateMarkersDotPlot, height = 6, width = 12)

CandidateMarkersDotPlot2<-  DotPlot(PTcells, features =  CandidateMarkers2, col.min = -1) +RotatedAxis()
CandidateMarkersDotPlot2
ggsave("PT_CandidateMarkersDotPlot_2.pdf", plot = CandidateMarkersDotPlot2, height = 6, width = 12)
