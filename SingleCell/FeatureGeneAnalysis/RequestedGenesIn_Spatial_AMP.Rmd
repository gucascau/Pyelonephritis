...
# single cell with CD45 positive cells
CD45indir = "/Users/XXW004/Documents/Projects/RuizRosado/SpatialTranscriptomic/Results/Deconvolution_Six_Immune_V12092024/"
...
# Briefly Go through the features of the Single cell and Spatial datasets
```{r}

#

CD45_ImmuneCellObj<- readRDS(paste0(CD45indir, "CD45_ImmuneCell_withSubCluster.rds"))


# In order to better understand these cells, we only selected the single cells that have well annotation
CD45_ImmuneCellObj@meta.data %>% head()

CD45_ImmuneCellObj_subimm <- subset(CD45_ImmuneCellObj, idents = c("ResMac_1", "ResMac_2","MonoDerivedMac1", "ResDendric", "ResMac_3", "MonoDerivedMac2","Neutrophils_0", "Neutrophils_1", "Neutrophils_2", "Neutrophils_3","B cells", "T cells", "NK cells" ))

CD45_ImmuneCellObj_subimm

CD45_ImmuneCellObj_subimm <- JoinLayers(CD45_ImmuneCellObj_subimm)
levels(as.factor(CD45_ImmuneCellObj_subimm@meta.data$FinalAnn))

Allimmune<-subset(CD45_ImmuneCellObj, idents = c("ResMac_1", "ResMac_2","MonoDerivedMac1", "ResDendric", "ResMac_3", "MonoDerivedMac2","Neutrophils_0", "Neutrophils_1", "Neutrophils_2", "Neutrophils_3","B cells", "T cells", "NK cells" ))

# change the CD45_ImmuneCellObj name: 
...
#
#CD45_ImmuneCellObj@meta.data <-
#  

# CD45_ImmuneCellObj_subimm@meta.data <-
#   CD45_ImmuneCellObj_subimm@meta.data %>%mutate(
#     FinalAnnotation =
#       case_when(
#         FinalAnn %in% c("7: T Cells/NK Cells") ~ "T_Cells",
#         #
#         FinalAnn %in% c("19: B Cells") ~ "B_Cells",
# 
#         # 
#         .default = as.character(FinalAnn)
#       )
#   )



Idents(CD45_ImmuneCellObj_subimm) <- "FinalAnn"
length(levels(Idents(CD45_ImmuneCellObj_subimm)))
# set up the order 
...
Idents(CD45_ImmuneCellObj_subimm)<- ordered(factor(Idents(CD45_ImmuneCellObj_subimm)),levels=CelltypeOrder)


DimPlot(CD45_ImmuneCellObj_subimm,label = T, label.size = 2)
# DefaultAssay(CD45_ImmuneCellObj) <-"RNA"
# 
