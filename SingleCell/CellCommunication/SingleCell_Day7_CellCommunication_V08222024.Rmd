...
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/PIPseq/Results/Evaluation_V022723/CellEvaluation_Subclustering_V0803/Cell_CellCommunication/OverallDay7/"
...
nrow(Pyelonephritis_InfectionSubslidesD07@meta.data)
SingleCellObj
### create a cellchat object

cellChat <- createCellChat(object = Pyelonephritis_InfectionSubslidesD7, group.by = "DataSet", assay = "RNA")
...
saveRDS(cellchat, file = "SingleCellDate7.rds")

# read the object
cellchat<- readRDS("SingleCellDate7.rds")
...
# check the subset of cellular communication network of 
...
pdf("SignalingSedingFromAllCellTypes_Date7.pdf", height = 6, width = 12)
...
nrow(mat)
pdf("SignalingSedingFromEachCelltype_Date7.pdf", height = 30, width = 30)
...
# 
pathways.show <- c("CXCL","CCL","TNF","IFN-II") 
# Hierarchy plot
# Here we define `vertex.receive` so that the left portion of the hierarchy plot shows signaling to fibroblast and the right portion shows signaling to immune cells 
vertex.receiver = seq(1,4) # a numeric vector. 

#cellchat@net$LRs
pdf("Pathwayshow_Date7.pdf", height = 6, width = 6)
netVisual_aggregate(cellchat, signaling = pathways.show,  vertex.receiver = vertex.receiver)
dev.off()
# Circle plot
pdf("Pathwayshow_Cxcl_CCL_Date7.pdf", height = 6, width = 6)
par(mfrow=c(1,1))
netVisual_aggregate(cellchat, signaling = pathways.show, layout = "circle")
dev.off()
# using the chord diagram
pdf("Pathwayshow_Cxcl_CCL_Date7_Chord.pdf", height = 5, width = 5)
netVisual_aggregate(cellchat, signaling = pathways.show, layout = "chord")
dev.off()

# Compute the contribution of each ligand-receptor pair to the overall signaling pathway and visualize cell-cell communication mediated by a single ligand-receptor pair
# generate the ligand receptor pairs
pdf("Pathwayshow_Cxcl_CCL_Date7_netAnalysis_contribution.pdf", height = 5, width = 5)
...
write.csv(Test$LR.contribution, file = "Chemokine_Cytokine_Cell_Contribution_date7.csv")

  #RequestLigendReceptors[[i]] <- Test$LR.contribution
# generate the potential interactions
for (i in pairLR.CXCL$interaction_name){
  pdf(paste0(i,"PairedPathwayshow_Chord_Date7.pdf"), height = 4, width = 4)
...
pdf("PairedPathwayshow_CXCL1_CXCR2_Chord.pdf", height = 5, width = 5)
netVisual_individual(cellchat, signaling = pathways.show, pairLR.use = LR.show, layout = "chord")
dev.off()

pdf("PairedPathwayshow_CCL_CXCL_DotPlots.pdf", height = 3.5, width = 7)
netVisual_bubble(cellchat, signaling = c("CCL","CXCL","TNF"), remove.isolate = FALSE)
dev.off()
