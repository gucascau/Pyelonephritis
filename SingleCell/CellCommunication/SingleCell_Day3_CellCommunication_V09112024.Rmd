...
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/PIPseq/Results/Evaluation_V022723/CellEvaluation_Subclustering_V0803/Cell_CellCommunication/OverallDay3/"
...
Pyelonephritis_InfectionDay3 <- 
    subset (SingleCellObj, subset= (DataSet == "3DPI"))
Pyelonephritis_InfectionDay3
nrow(Pyelonephritis_InfectionDay3@meta.data)
Pyelonephritis_InfectionDay3 %>% head()
### create a cellchat object

cellchat <- createCellChat(object = Pyelonephritis_InfectionDay3, group.by = "FinalAnnotation", assay = "RNA")
...
nrow(mat)
pdf("SignalingSedingFromEachCelltype_Day3.pdf", height = 40, width = 40)
...
for (i in pairLR.CXCL$interaction_name){
  pdf(paste0(i,"PairedPathwayshow_Chord_Day3.pdf"), height = 4, width = 4)
