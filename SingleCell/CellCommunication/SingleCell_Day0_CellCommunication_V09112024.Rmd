...
Outdir = "/Users/XXW004/Documents/Projects/RuizRosado/PIPseq/Results/Evaluation_V022723/CellEvaluation_Subclustering_V0803/Cell_CellCommunication/Control/"
...
Pyelonephritis_InfectionDay0 <- 
    subset (SingleCellObj, subset= (DataSet == "0DPI"))
Pyelonephritis_InfectionDay0
nrow(Pyelonephritis_InfectionDay0@meta.data)
Pyelonephritis_InfectionDay0 %>% head()
### create a cellchat object

cellchat <- createCellChat(object = Pyelonephritis_InfectionDay0, group.by = "FinalAnnotation", assay = "RNA")
...
for (i in pairLR.CXCL$interaction_name){
  pdf(paste0(i,"PairedPathwayshow_Chord_Day0.pdf"), height = 4, width = 4)
